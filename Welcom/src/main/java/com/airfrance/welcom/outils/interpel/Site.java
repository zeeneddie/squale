...
public class Site {
     ...
     */
    public static Site getSite(final String site) throws SiteException {
        if (site == null) {
            throw new SiteException("Site 'null' Non reconnu par interpel \n Utiliser (TLS,QVG,QVI,AIRINTER TLS,VLBTCP,QVGTCP)");
        }
        ...
        if (site.toUpperCase().equals("TLS") || site.toUpperCase().equals("AIRINTER")) {
            ...
            throw new SiteException("Site '" + site + "' Non reconnu par interpel \n Utiliser (TLS,QVG,QVI,AIRINTER TLS,VLBTCP,QVGTCP)");
        }
    }
