...
public class StatementAssembly {
    ...
    /**
     * Permet de contruire rapidement une liste de valeur
     * 1,2,3,4 (separateur ',' et  tableau de int)
     ...
     * 
     * Permet de contruire rapidement une liste de valeur
     * "1","2","3","4" (separateur ',' et  tableau de object)
    ...
    /**
    * Permet de contruire rapidement une liste de valeur
    * "1","2","3","4" (separateur ',' et  tableau de String)
    ...
    */
     ...
     *  @return  Creates and returns a {@link IStatement} based on the SQL and parameters
     *  acquired.
     *  @throws SQLException : Probleme lors de la creation du Statement (@link ParameterizedStatement ou @link SimpleStatement)
     * 
     */
    public IStatement createStatement(final Connection connection) throws SQLException {
        String sql;
        IStatement result;
