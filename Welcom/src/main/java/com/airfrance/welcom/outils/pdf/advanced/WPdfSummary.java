...
public class WPdfSummary
{
     ...
     */
    private void createSummary( final Document doc )
        throws DocumentException
    {
        ...
        if ( list != null )
        {
            ...
            while ( it.hasNext() )
            {
                ...
                /*
                 * Anchor anchor = new Anchor((String)ht.get("Title")); //anchor1.set anchor.setReference("#2" );
                 * doc.add(anchor);
                 */

                /*
                 * final Enumeration enumeration = ht.keys(); while (enumeration.hasMoreElements()) { final String key =
