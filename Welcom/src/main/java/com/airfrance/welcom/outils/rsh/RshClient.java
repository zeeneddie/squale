...
public abstract class RshClient
{
    ...
    /**
     * Change le repertoire courant par celui spécifié en parmetre Fonctione seulement en absolu
     * 
     * @param pDirectory Chemin
     * @throws IOException probleme sur l'execution de la commande
     * @return retour de commande unix
     */
    public int changeDirectory( final String pDirectory )
        throws IOException
    {
     ...
     * @return retour de commande unix
     */
    public int removeFile( final String fileName )
        throws IOException
    {
     ...
     * @return retour de commande unix
     */
    public int sendFile( final String fileName, final String data )
        throws IOException
    {
     ...
     * @return retour de commande unix
     */
    public int executecmd( final String cmd )
        throws IOException
    {
     ...
     * @return retour de commande unix
     */
    public abstract int executecmd( String cmd, byte buff[] )
        throws IOException;
     ...
     */
    public int sendFile( final String fileName, final byte fileData[] )
        throws IOException
    {
