...
public class WPdfFieldWriter {
     ...
     * @throws DocumentException exception pouvant etre levee
     */
    private void fillField(final WPdfField pdfField, final boolean lock) throws IOException, DocumentException {
     ...
     * @throws DocumentException exception pouvant etre levee
     */
    private void fillField(final String fieldName, final String value, final boolean lock) throws IOException, DocumentException {
