...
/**
 * Insérez la description du type ici. Date de création : (30/11/2001 11:22:34)
 * 
...
public class Util
{
    ...
    /**
     * Insérez la description de la méthode ici. Date de création : (24/06/2002 15:01:50)
     * 
    ...
    /**
     * Insérez la description de la méthode ici. Date de création : (16/10/2002 10:00:00)
     * 
    ...
    public static final String formatAccent( final String st )
    {
        ...
        return st.replaceAll( "[âäàáåæÄÂÃÀÁÆ]", "a" ).replaceAll( "[éêëèÊËÈÉ]", "e" ).replaceAll( "[ïîÏÎÌÍ]", "i" ).replaceAll(
                                                                                                                                "[ôöòóÔÖÒÓÕ]",
                                                                                                                                "o" ).replaceAll(
                                                                                                                                                  "[üùúûÜÛÙÚ]",
                                                                                                                                                  "u" ).replaceAll(
    ...
    /**
     * Insérez la description de la méthode ici. Date de création : (12/12/2001 11:18:30)
     * 
    ...
    /**
     * Insérez la description de la méthode ici. Date de création : (05/06/2002 11:39:06)
     * 
     * @return boolean
    ...
    /**
     * Insérez la description de la méthode ici. Date de création : (21/02/2003 15:38:46)
     * 
     * @return java.lang.String
