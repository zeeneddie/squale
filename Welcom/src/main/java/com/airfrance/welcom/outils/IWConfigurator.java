...
interface IWConfigurator {
	...
	public static final String ADDONS_ACCESS_MANAGER_TABLE_PROFILEACCESSKEYINT = "addons.accessManager.table.profileaccesskeyint";
	public static final String ADDONS_MESSAGE_MANAGER_TABLE_LIBELLES = "addons.messageManager.table.libelles";
	public static final String ADDONS_ACCESS_MANAGER_TABLE_PROFILEACCESSKEY = "addons.accessManager.table.profileaccesskey";
	...
	public static final String ADDONS_CONFIG_HIBERNATE_PROVIDERPERSISTENCE = "addons.config.hibernate.providerpersistence";
	...
	public static final String EASY_COMPLETE_DEFAULT_MAXIMUM_RETURNED_ELEMENTS = "easyComplete.default.maximum.returned.elements";
	...
	public static final String CHARTEV2_ONGLET_STYLE_NON_SELECTIONNER_LEFT = "chartev2.onglet.style.nonSelectionner.left";
	public static final String CHARTEV2_ONGLET_STYLE_SELECTIONNER_CENTER = "chartev2.onglet.style.selectionner.center";
	public static final String CHARTEV2_ONGLET_STYLE_NON_SELECTIONNER_CENTER = "chartev2.onglet.style.nonSelectionner.center";
	public static final String CHARTEV2_ONGLET_STYLE_SELECTIONNER_RIGHT = "chartev2.onglet.style.selectionner.right";
	public static final String CHARTEV2_ONGLET_STYLE_NON_SELECTIONNER_RIGHT = "chartev2.onglet.style.nonSelectionner.right";
