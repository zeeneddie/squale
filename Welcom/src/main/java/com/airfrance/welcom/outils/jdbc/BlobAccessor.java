...
public class BlobAccessor
{
     ...
     */
    public void write( final WStatement statement, final String column, final byte data[] )
     ...
     * @throws IOException io exception
     */
    public void write( final WStatement statement, final String column, final String data )
        throws ServletException, SQLException, IOException
    {
        if ( statement.getSQL().toLowerCase().indexOf( "for update" ) < 0 )
        {
     ...
     * @throws IOException io exception
     */
    public void write( final WStatement statement, final String column, final InputStream data )
        throws ServletException, SQLException, IOException
    {
        if ( statement.getSQL().toLowerCase().indexOf( "for update" ) < 0 )
        {
     ...
     * @throws IOException io exception
     */
    public byte[] getBytes( final ResultSet rs, final String column )
        throws ServletException, SQLException, IOException
    {
        byte b[] = null;
     ...
     * @throws IOException io exception
     */
    public String getString( final ResultSet rs, final String column )
        throws ServletException, SQLException, IOException
    {
        String result = "";
    ...
    /**
     * ATTENTION. Si le paramètre zipped du BlobAccessor est à true cette methode retourne un GZIPInputStream pour lire
     * les données "dézipées" il faut le tanstyper avant la lecture.
     * 
     * @param rs : java.sql.ResultSet comprenant la colonne du blob
     * @param column : nom de la colone du blob.
     ...
     * @throws IOException io exception
     */
    public InputStream getInputStream( final ResultSet rs, final String column )
        throws ServletException, SQLException, IOException
    {
        if ( ( rs != null ) && rs.next() )
        {
