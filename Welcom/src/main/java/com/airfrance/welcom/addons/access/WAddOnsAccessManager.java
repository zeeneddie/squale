 ...
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public class WAddOnsAccessManager extends WAddOns {
    /** logger */
    ...
    public void init(final ActionServlet servlet, final ModuleConfig config) throws AddonsException {
        ...
        final String excelFile = WelcomConfigurator.getMessage(WelcomConfigurator.ADDONS_ACCESS_MANAGER_CONFIG_EXCEL_PATH);
    ...
    public void initMappings(final ActionServlet servlet, final ModuleConfig config) throws AddonsException {
        ...
        // Liste des profils
        initMappings(servlet, config, null, "addons.accessManager.jsp.profiles", "/wProfileList", "com.airfrance.welcom.addons.access.action.WProfileListeAction");
        ...
        initMappings(servlet, config, "wProfileBean", "addons.accessManager.jsp.profile", "/wProfile", "com.airfrance.welcom.addons.access.action.WProfileAction");
