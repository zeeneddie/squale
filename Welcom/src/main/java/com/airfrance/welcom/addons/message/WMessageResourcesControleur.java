...
public class WMessageResourcesControleur {
    ...
    /**
     *   Singleton -> Constructor will be private
     *
     *   just one Application per JVM allowed
     */
     ...
     * The one and only ApplicationModel is stored in a static member.
     * There can be only one ApplicationModel per JVM.
