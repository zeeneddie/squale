...
public class WSpellChecker {
     ...
     */
    private SpellChecker findSpellChecker(final String locale) throws WSpellCheckerNotFound {
     ...
     * @throws WSpellCheckerNotFound Le dictionnaire n'est pas disponible
     */
    private SpellChecker loadSpellChecker(final String locale) throws WSpellCheckerNotFound {
        ...
        try {
            ...
            spellCheck.addDictionary(
                new SpellDictionaryHashMap(new java.io.InputStreamReader(myLoader.getResourceAsStream(dictFile)), new java.io.InputStreamReader(myLoader.getResourceAsStream(phonetFile))));
        ...
        logStartup.info("Chargement du  dictionnaire '" + locale + "' terminé (" + (System.currentTimeMillis() - startTime) + "ms)");
     ...
     * @throws WSpellCheckerNotFound Le dictionnaire n'est pas disponible
     */
    public static SpellChecker getSpellChecker(final String locale) throws WSpellCheckerNotFound {
        if (instance == null) {
