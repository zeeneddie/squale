...
public class AddonsConfig {
    ...
    public final static String WEL_ACCESSKEY = WelcomConfigurator.getMessage(WelcomConfigurator.ADDONS_ACCESS_MANAGER_TABLE_ACCESSKEY);

    /** Table de profil */
    public final static String WEL_PROFILE = WelcomConfigurator.getMessage(WelcomConfigurator.ADDONS_ACCESS_MANAGER_TABLE_PROFILE);

    /** Table de droits d'accées par profil (referentiel) */
    public final static String WEL_PROFILE_ACCESSKEY_INT = WelcomConfigurator.getMessage(WelcomConfigurator.ADDONS_ACCESS_MANAGER_TABLE_PROFILEACCESSKEYINT);

    /** Table de droits d'accées par profil (utilisateur) */
    public final static String WEL_PROFILE_ACCESSKEY = WelcomConfigurator.getMessage(WelcomConfigurator.ADDONS_ACCESS_MANAGER_TABLE_PROFILEACCESSKEY);

    /** Table de droits d'accées par profil (utilisateur) */
    public final static String WEL_MSGLIBELLE = WelcomConfigurator.getMessage(WelcomConfigurator.ADDONS_MESSAGE_MANAGER_TABLE_LIBELLES);
    ...
    */
    public static void init(final ActionServlet servlet, final ModuleConfig config) {
        ...
        final String accessManagerEnabled = WelcomConfigurator.getMessage(WelcomConfigurator.ADDONS_ACCESS_MANAGER_ENABLED);
        ...
        final String messageManagerEnabled = WelcomConfigurator.getMessage(WelcomConfigurator.ADDONS_MESSAGE_MANAGER_ENABLED);
        ...
        final String spellManagerEnabled = WelcomConfigurator.getMessage(WelcomConfigurator.ADDONS_SPELL_MANAGER_ENABLED);
     ...
     */
    public void initAddons(final Class addonsClass, final ActionServlet servlet, final ModuleConfig config) throws AddonsException {
     ...
     */
    public void registredAddons(final WJdbc jdbc, final WIAddOns addons) throws SQLException {
     ...
     * @throws AddonsException : Probleme de chargement
     */
    public void saveAddons(final WIAddOns addons) throws AddonsException {
     ...
     * @throws AddonsException : Probleme de chargement
     */
    public void saveAddons(final WJdbc jdbc, final WIAddOns addons) throws AddonsException {

        try {
            final WStatement sta = jdbc.getWStatement();
            /*            sta.add("drop table WEL_ADDONS");
                        sta.executeUpdate();
                        sta.close();
     ...
     */
    public void createTablesAddons(final WJdbc jdbc) throws SQLException {
        final WStatement sta = jdbc.getWStatement();
