 ...
 *
 */
public class MessageResourcesAddons extends WPropertyMessageResources implements java.io.Serializable {
    /**
     * 
     */
     ...
     */
    public MessageResourcesAddons(final MessageResourcesFactoryAddons factory, final String messageConfig, final boolean returnNull) {
    ...
    * @param messageConfig Configuration information.
    */
    public MessageResourcesAddons(final MessageResourcesFactoryAddons messageResourcesFactory, final String messageConfig) {
    ...
    private synchronized void cacheLocale(final Locale locale) {
        ...
        final Vector Messages = WMessageResourcesControleur.getWMessageResourcesControleur().getMessagesByLanguage(askedLocale);
    ...
    public String getMessage(final Locale currentLocale, final String askedKey) {
        ...
        if (resultingMessage == null) {
            ...
            if (resultingMessage == null) {
                //on a pas trouve la valeur par defaut, on regarde dans le fichier DefaultMessage
