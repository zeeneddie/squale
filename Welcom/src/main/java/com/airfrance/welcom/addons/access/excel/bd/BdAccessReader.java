...
public class BdAccessReader {
     ...
     */
    public ArrayList getProfileAccessKey(final WJdbc jdbc, final boolean resetCache) throws SQLException {
     ...
     * @throws SQLException : Erreur SQL
     */
    public ArrayList getProfile(final WJdbc jdbc, final boolean resetCache) throws SQLException {
    ...
    * @return Retourne la liste des droits diponibles
     * @throws SQLException erreur sql
    */
    public ArrayList getAccessKey(final WJdbc jdbc, final boolean resetCache) throws SQLException {
     ...
     * @throws SQLException erreur sql
     */
    public void readProfileAccessKey(final WJdbc jdbc) throws SQLException {
     ...
     * @throws SQLException erreur sql
     */
    public void readProfile(final WJdbc jdbc) throws SQLException {
     ...
     * @throws SQLException erreur sql
     */
    public void readAccessKey(final WJdbc jdbc) throws SQLException {
