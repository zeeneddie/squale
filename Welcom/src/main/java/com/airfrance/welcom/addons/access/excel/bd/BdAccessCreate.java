...
public class BdAccessCreate {
    ...
    */
     ...
     */
    private void checkVersion(final WJdbc jdbc) throws SQLException {
        ...
        if (version.equals("2.2")) {
            try {
                ...
                sta.executeUpdate();
                sta.close();
                logStartup.info("Table " + AddonsConfig.WEL_PROFILE_ACCESSKEY_INT + " : colonne KEY renommee en ACCESSKEY");
                ...
                sta = jdbc.getWStatement();
                sta.add("update " + AddonsConfig.WEL_ADDONS + " set VERSION='2.3' where NAME='ADDONS_ACCESSMANAGEMENT'");
                sta.executeUpdate();
                sta.close();
                jdbc.commit();
    ...
    */
    private void createTable(final WJdbc jdbc, final String pTable) throws SQLException {
        ...
        if (com.airfrance.welcom.outils.Util.isEquals(pTable, AddonsConfig.WEL_ACCESSKEY)) {
            createTableWelAccessKey(jdbc);
        } else if (com.airfrance.welcom.outils.Util.isEquals(pTable, AddonsConfig.WEL_PROFILE)) {
            createTableWelProfile(jdbc);
        } else if (com.airfrance.welcom.outils.Util.isEquals(pTable, AddonsConfig.WEL_PROFILE_ACCESSKEY_INT)) {
            createTableWelProfileAccessKeyInternal(jdbc);
        } else if (com.airfrance.welcom.outils.Util.isEquals(pTable, AddonsConfig.WEL_PROFILE_ACCESSKEY)) {
    ...
    * Creation de la table WEL_ACCESSKEY 
    * @param jdbc : Connexion jdbc 
    * @throws SQLException Probleme SQL
    */
    private void createTableWelAccessKey(final WJdbc jdbc) throws SQLException {
        final WStatement sta = jdbc.getWStatement();
    ...
    * IDPROFILE     VARCHAR2 (50), 
    * NAME          VARCHAR2 (255))
    
    * Creation de la table WEL_PROFILE 
    * @param jdbc : Connexion jdbc 
    * @throws SQLException Probleme SQL
    */
    private void createTableWelProfile(final WJdbc jdbc) throws SQLException {
        final WStatement sta = jdbc.getWStatement();
    ...
    * Creation de la table WEL_PROFILE_ACCESSKEY_INTERNAL
    * @param jdbc : Connexion jdbc 
    * @throws SQLException Probleme SQL
    */
    private void createTableWelProfileAccessKeyInternal(final WJdbc jdbc) throws SQLException {
        final WStatement sta = jdbc.getWStatement();
     ...
     * @throws SQLException Probleme SQL
     */
    private void createTableWelProfileAccessKey(final WJdbc jdbc) throws SQLException {
        final WStatement sta = jdbc.getWStatement();
