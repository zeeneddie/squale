 ...
 * Class WForm
 */
public class JActionForm extends ActionForm {
    /**
     * 
     */
    ...
    public final ActionErrors validate(final ActionMapping mapping, final HttpServletRequest pRequest) {
        ...
        if (!mapping.getModuleConfig().getControllerConfig().getProcessorClass().equals("com.airfrance.welcom.struts.action.WRequestProcessor")) {
            // Search Date/Heure
     ...
     */
    public void wValidate(final ActionMapping mapping, final HttpServletRequest pRequest, final WJdbc pJdbc) throws SQLException {
        //return null;
    }
     ...
     * @throws SQLException exception
     */
    public ActionErrors validateOld(final ActionMapping mapping, final HttpServletRequest pRequest, final WJdbc pJdbc) throws SQLException {
        return null;
    }
     ...
     */
    public void addError(final String property, final String actionErrorKey, final String arg0, final String arg1, final String arg2) {
     ...
     */
    public void addError(final String property, final String actionErrorKey, final String arg0, final String arg1, final String arg2, final String arg3) {
     ...
     */
    public void addError(final String property, final String actionErrorKey, final String arg0, final String arg1, final String arg2, final String arg3, final String arg4) {
