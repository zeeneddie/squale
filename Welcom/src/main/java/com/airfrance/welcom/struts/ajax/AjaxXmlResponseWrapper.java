...
/**
 * @author Rémy Bouquet/Arnaud Lehmann
 *
 * Wrapper pour construire une réponse Http xml pour l'implémentation Ajax.  
 */
public class AjaxXmlResponseWrapper {
    ...
    /**
    * ecrit le flux xml dans la response et ferme le flux
    * On envoi systematiquement le tag root
    * pour corriger des problemes IE sous UNIX quand
    * rien ne matche .. (il bloque)
