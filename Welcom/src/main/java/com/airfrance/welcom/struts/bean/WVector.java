 ...
 *
 */
public class WVector extends ActionForm implements List {
    /**
     * 
     */
     ...
     *  Date de création : (29/10/2001 14:29:36)
     * @return int
     */
    public int getSize() {
        return vector.size();
    ...
    /**
     * Insérez la description de la méthode ici.
     *  Date de création : (12/12/2001 16:10:26)
    ...
    /**
     * Insérez la description de la méthode ici.
     *  Date de création : (29/10/2001 14:48:15)
     * @param i l'index
    ...
    /**
     * Insérez la description de la méthode ici.
     *  Date de création : (29/10/2001 14:25:18)
