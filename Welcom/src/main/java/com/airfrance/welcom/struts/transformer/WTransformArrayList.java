...
public class WTransformArrayList {
     ...
     */
    public static ArrayList objToForm(final ArrayList list, final WITransformer transformer) throws WTransformerException {
     ...
     */
    public static ArrayList formToObj(final ArrayList listForm, final WITransformer transformer) throws WTransformerException {
        final ArrayList returnList = new ArrayList();
     ...
     */
    public static void formToObj(final ArrayList listForm, final ArrayList listObject, final WITransformer transformer) throws WTransformerException {
