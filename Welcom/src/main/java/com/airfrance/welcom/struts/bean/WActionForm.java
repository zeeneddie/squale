 ...
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public class WActionForm extends ActionForm {
    ...
    public final ActionErrors validate(final ActionMapping mapping, final HttpServletRequest request) {
        ...
        // Recupere le user        
        if (((request.getSession().getAttribute(WConstants.USER_KEY)) != null) && (request.getSession().getAttribute(WConstants.USER_KEY) instanceof WILogonBean)) {
    ...
    /**
     * Trace si on a pas ete initialise par la methode validate
