...
/**
 * Cette super-classe contient les méthode de cryptage/décryptage des attributs d'un bean.
 * Elle doit être héritée par les bean qui ont des attributs cryptés.
 * Les sous-classes doivent définir un tableau cryptableAttr suivant:
 *
 * Date de création : (07/10/2002 15:56:50)
 * @author: Administrator
 */
public class JCryptable extends JActionForm {
    /**
     * 
     */
    ...
    /**
     * Crypte les attributs cryptés d'un Bean
     *  Date de création : (07/10/2002 15:57:23)
    ...
    /**
     * Decrypte les attributs cryptés d'un Bean
     *  Date de création : (07/10/2002 15:57:13)
     * @param conn la connection
     * @throws JCryptableException exception pouvant etre levee
     */
     ...
     *  Date de création : (07/10/2002 16:56:21)
