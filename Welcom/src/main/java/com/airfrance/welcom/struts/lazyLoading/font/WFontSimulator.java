...
public class WFontSimulator
{
    ...
    private void loadFont( final String font )
        throws IOException
    {
        final String fileName = "/com/airfrance/welcom/struts/lazyLoading/font/" + font + ".properties";
    ...
    /**
     * Calcule la taille de la chaine en tenant compte des chaines découpées sur plusieurs lignes avec les chr : \n et
