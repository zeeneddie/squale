 ...
 * AutoCompleteTag
 */
public class WBaseAutoCompleteTag extends WBaseTextTag {
    /**
     * 
     */
    ...
    /**
     * Ajoute la fonction javascript de l'ajout de l'autocompletion sur le
     * onkeyup
     */
    ...
    private String getJavascriptEasyComplete() {
        ...
        if ((!GenericValidator.isBlankOrNull(easyCompleteName) || !GenericValidator.isBlankOrNull(easyCompleteCallBackUrl))) {
            ...
            buf.append(getJavascriptParam(easyCompleteDecorationClass,WelcomConfigurator.getMessage(WelcomConfigurator.EASY_COMPLETE_DEFAULT_DECORATION_CLASS)));
