...
/**
 * Classe utilitaire pour les tags
 * Date de création : (21/12/2001 14:19:20)
 */
public class TagUtils {
     ...
     */
    public static String getDateHeureFromDateTag(final javax.servlet.http.HttpServletRequest request, final String property) {
     ...
     */
    public static void prepareIndex(PageContext pageContext,TagSupport tag, MessageResources messages,StringBuffer handlers,String name )
        throws JspException {
     ...
     */
    public static String getJavascriptCheckValue(String property,String type,boolean isRequired,boolean isUpperCase,boolean isFirstUpperCase,boolean accent) {
        
        return "checkValue(this, '" + property + "','" + type + "'," + isRequired + "," + isUpperCase + "," + isFirstUpperCase + "," + accent + ");";
     ...
     * @return la fonction javascript correspondante
     */
    public static String getJavascriptCheckValue(String property,String type,boolean isRequired,boolean isUpperCase,boolean isFirstUpperCase,boolean accent,String datepattern) {
        
        return "checkValue(this, '" + property + "','" + type + "'," + isRequired + "," + isUpperCase + "," + isFirstUpperCase + "," + accent + ",'"+datepattern+"');";
