 ...
 *
 */
public class MenuSkinV3001 implements IMenuRender {
    /** constante*/
    ...
    public String doPrintBase(final JSMenu menu, int level) {
        ...
        buf.append(menu.getName() + " = new comMenuAF_Vx(" + menu.getOrientation() + " , \"t" + menu.getName() + "-" + level + "\");\n");
    ...
    /**
     * @see com.airfrance.welcom.taglib.menu.IMenuRender#doPrint(com.airfrance.welcom.taglib.menu.JSMenuItem, com.airfrance.welcom.taglib.menu.JSMenuBase, java.lang.String, int, int)
     */
     ...
     */
    public String doPrintHeader(final Tag tag, final PageContext pageContext) throws JspException {
        final StringBuffer buf = new StringBuffer();

        if (pageContext.getRequest().getAttribute(MENU_KEY) == null) {
            CanvasUtil.addJs(WelcomConfigurator.getMessage(WelcomConfigurator.CHARTEV3_MENU_JSURL), tag, pageContext);
            buf.append("<script language=\"JavaScript\">\n");
            /*if ("app".equalsIgnoreCase(WelcomConfigurator.getMessage("chartev3.id"))) {
                buf.append("var Menu_Horizontal_Application = true;\n");
