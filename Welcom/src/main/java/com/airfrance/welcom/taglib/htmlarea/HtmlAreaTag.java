 ...
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public class HtmlAreaTag extends BodyTagSupport {
    /**
     * 
     */
    ...
    public HtmlAreaTag() {
		...
		cssurl = WelcomConfigurator.getMessage("htmlarea.default.cssurl" + "." + charte.getVersionMajor()+"."+charte.getVersionMinor());
    ...
    private void initHtmlArea() throws JspException {
        ...
        if (pageContext.getRequest().getAttribute(KEY) == null) {
            ...
            sb.append("<script type=\"text/javascript\" src=\"" + prefix + path + "lang/" + localeRequest.getLanguage() + ".js\"></script>\n");
        }
        ...
        if (pluginList != null) {
            for (final Iterator iter = pluginList.iterator(); iter.hasNext();) {
                ...
                if (plg.equals("CSS")) {
                    ...
                    sb.append("options: {");
                    final String styleKey = "htmlarea.default.styles" + "." + WelcomConfigurator.getCharte().getVersionMajor()+"."+WelcomConfigurator.getCharte().getVersionMinor();
     ...
     * @throws JspException jsp exception
     */
    private void genEditor() throws JspException {
        final TrimStringBuffer sb = new TrimStringBuffer();
    ...
    private void writeTextArea() throws JspException {
        ...
        if (o == null) {
            final JspException e = new JspException("Objet " + name + ", " + property + " introuvable dans le scope : " + scope + " ou n'a pas été initialisé");
    ...
    private void writeContent() throws JspException {
        ...
        if (o == null) {
            final JspException e = new JspException("Objet " + name + "," + property + " introuvable dans le scope : " + scope);
            RequestUtils.saveException(super.pageContext, e);
            throw e;
        }
