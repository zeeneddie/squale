 ...
 */
public class TableNavigatorRendererV200X implements ITableNavigatorRenderer {
    ...
    public String drawBar(MessageResources resources, Locale localeRequest, String formName, String href, int pFrom, int pVolume, int pLength, int ipagesPerNavBar, String tableName) {
        ...
        if (ipagesPerNavBar > 1) {
            ...
            for (int i = ifrom; i < to; i += pLength) {
                ...
                if (pFrom == i) {
                    sb.append("<option value=\"" + getURLNavigation(formName, href, i, tableName) + "\" selected>" + pageNumber);
                } else {
                    sb.append("<option value=\"" + getURLNavigation(formName, href, i, tableName) + "\">" + pageNumber);
                }
            }
        ...
        sb.append(writeFirstPreviousButton(formName, txtFirst, txtPrev, urlFirst, urlPrevisous, hasPrevisousPage, isFirstPage));
     ...
     * @return les boutons
     */
     private String writeFirstPreviousButton(String formName, String txtFirst, String txtPrev, String urlFirst, String urlPrevisous, boolean hasPrevisousPage, boolean isFirstPage) {
     ...
     * @return les boutons
     */
    private String writeNextLastButton(String formName, String txtNext, String txtLast, boolean isLastPage, boolean hasNextPage, String urlNext, String urlLast) {
        StringBuffer sb = new StringBuffer();
        if (!isLastPage) {
            if (hasNextPage) {
