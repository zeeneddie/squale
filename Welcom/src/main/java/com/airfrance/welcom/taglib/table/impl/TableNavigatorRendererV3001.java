 ...
 */
public class TableNavigatorRendererV3001 implements ITableNavigatorRenderer {
	/** parametre du tag*/
     ...
     * @return flux html
     */
    private String writeButtonNav(String formName, final String srcImg, final String labelImg, final String link, final boolean swap) {
        final StringBuffer sb = new StringBuffer();
    ...
    private String swapParams(final String arg0, final String arg1, final String arg2, boolean swap) {
        if (!swap) {
            return ((arg0 != null) ? arg0 : "") + ((arg1 != null) ? arg1 : "") + ((arg2 != null) ? arg2 : "");
        } else {
            return ((arg2 != null) ? arg2 : "") + ((arg1 != null) ? arg1 : "") + ((arg0 != null) ? arg0 : "");
        }
    }
    ...
    public String drawBar(MessageResources resources, Locale localeRequest, String formName, String href, int pFrom, int pVolume, int pLength, int ipagesPerNavBar, String tableName) {
        ...
        for (int i = ifrom; i < to; i += pLength) {
            ...
            if (Util.isTrue(WelcomConfigurator.getMessage(WelcomConfigurator.CHARTEV3_LINK_SPAN_COMPATIBILITY)) && !GenericValidator.isBlankOrNull(formName)){
                sb.append(writeNumberOfPageAsSpan(pFrom >= i && pFrom < i + pLength,getURLNavigation(formName, href, i, tableName),pageNumber));
            } else {
                sb.append(writeNumberOfPageAsHref(pFrom >= i && pFrom < i + pLength,!GenericValidator.isBlankOrNull(formName),getURLNavigation(formName, href, i, tableName),pageNumber));
            }
    ...
    * @return les boutons
    */
     private String writeFirstPrevisousButton(String formName, String txtPrev, String urlFirst, String urlPrevisous, boolean hasPrevisousPage, boolean isFirstPage) {
        StringBuffer sb = new StringBuffer();
        if (isFirstPage) { //align=\"absmiddle\" border=\"0\"
     ...
     * @return les boutons
     */
    private String writeNextEndButton(String formName, String txtNext, String urlNext,String urlLast, boolean hasNextPage, boolean isLastPage) {
        StringBuffer sb = new StringBuffer();
        if (!isLastPage) {
            if (hasNextPage) {
