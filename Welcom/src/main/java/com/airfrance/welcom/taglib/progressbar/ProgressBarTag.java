    ...
    extends TagSupport
{
    ...
    /**
     * Fonction java script invoquée pour toute modification de l'etat de la progress bar.
     */
    private String onChangeHook = "null";

    /**
     * Fonction java script invoquée lors de l'arrêt de l'etat de la progress bar.
     */
    ...
    /**
     * Indique si la progressbar est en plein écran ou non. FullScreen => progressbar centrée dans une frame différente +
     * reste de la fenêtre figé par div translucide.
     */
        ...
        throws JspException
    {
        ...
        try
        {
            ...
            if ( isFullScreen() )
            {
                // out.println("<div height=\"50px\" width=\"100%\"
                // style=\"background-image:url(http://cmsintranet.airfrance.fr/charte_v03_001/img/lignage/lignage_trans.gif)\">&nbsp;</div>");
                ...
                // out.println("<div
                // style=\"background-image:url(http://cmsintranet.airfrance.fr/charte_v03_001/img/lignage/lignage_trans.gif);line-height:32px;\"
                // class=\"bg_theme\">&nbsp</div>");
            }
