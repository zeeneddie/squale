 ...
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public class ProgressbarRendererV3001 extends AbstractProgressbarRenderer{
	...
	public String drawRealProgressBar(String id)  {		
		...
		result.append("	<span style=\"float:left;width:0%;background-color:#ea5a00;height:10px\" id=\"" + id +"_all_td1\"></span>");
		result.append("</span>");
