 ...
 */
public class TableRendererV2001 implements ITableRenderer {

    /** logger */
    private static Log log = LogFactory.getLog(TableRendererV2001.class);

    /** constructeur */
    public TableRendererV2001() {
    ...
    */
    public String drawNavigation(String totalLabel, String navigation, String width) {
        ...
        if (!GenericValidator.isBlankOrNull(totalLabel)) {
            sb.append("\t\t <td valign=\"bottom\">" + totalLabel + "</td>");
        } else {
            sb.append("\t\t <td></td>");
        }
