...
public class WBaseTextareaTag extends TextareaTag implements IWelcomInputTag{
    ...
    private String getJavascriptForCheckValue() {
        ...
        return TagUtils.getJavascriptCheckValue(property, "TEXTAREA", isRequired, isUpperCase(), isFirstUpperCase(), accent);
