...
/**
 * Classe contenant plusieurs Aide Ressource en fonction de la locale
 *
...
public class Aide {
     ...
     */
    public void addAideRessource(final Locale locale) throws AideException {
        if (fileBundle != null) {
     ...
     * @throws AideException l'exception susceptible d'etre levee
     */
    public String getString(final String key, final Locale locale) throws AideException {
        try {
            ...
            log.info("Pour la Locale (" + locale.getCountry() + "_" + locale.getLanguage() + ") Key : " + key + " Value :" + value);
     ...
     * @throws AideException l'exception susceptible d'etre levee
     */
    public static String getUrlAide(final String key, final Locale locale) throws AideException {
        return Aide.getInstance().getPrefixURL() + locale.getLanguage() + "/" + Aide.getInstance().getString(key, locale);
    }
     ...
     * @throws AideException l'exception susceptible d'etre levee
     */
    public static void openAide(final String fileBundle, final String prefixURL) throws AideException {
     ...
     */
    public String getUrlDefault(final String key, final Locale locale) throws AideException {
        String value = "";
        ...
        try {
            ...
            log.warn("NOTFOUND : use key :" + AideRessource.KEY_DEFAULT + ", pour la Locale (" + locale.getCountry() + "_" + locale.getLanguage() + ") Key : " + key + " Value :" + value);
        } catch (final AideException ae) {
            log.warn("NOTFOUND : default key :" + AideRessource.KEY_DEFAULT + ", impossible d'afficher une page d'aide");
