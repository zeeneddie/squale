...
public class OptionsTag extends TagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        if ((selectTag.isForceReadWrite() == true) || ((pageAccess != null) && pageAccess.equals(Access.READWRITE)) || (pageAccess == null)) {
            ...
            if (collection != null) {
                ...
                for (final Iterator collIterator = getIterator(collection, null); collIterator.hasNext(); addOption(sb, stringValue, label.toString(), selectTag.isMatched(stringValue))) {
