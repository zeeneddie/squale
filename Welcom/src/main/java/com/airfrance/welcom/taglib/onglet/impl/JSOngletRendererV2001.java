 ...
 */
public class JSOngletRendererV2001 implements IJSOngletRenderer {
    ...
    public String drawTitle(final String name,final String titre,final String parentName,final int indice,boolean ongletSelected,final String onClickAfterShow) {
            ...
            if (ongletSelected) {
                buf.append("'" + WelcomConfigurator.getMessage(WelcomConfigurator.CHARTEV2_ONGLET_STYLE_SELECTIONNER_LEFT) + "'");
            } else {
                buf.append("'" + WelcomConfigurator.getMessage(WelcomConfigurator.CHARTEV2_ONGLET_STYLE_NON_SELECTIONNER_LEFT) + "'");
            }

            buf.append(">&nbsp;</td>");

            //center
            buf.append("<td onclick=\"F_OngletSelectionner( '" + parentName + "', '" + name + "'," + name + "" + indice + "Av, this," + name + "" + indice + "Ap )");
            ...
            if (ongletSelected) {
                buf.append(" class='" + WelcomConfigurator.getMessage(WelcomConfigurator.CHARTEV2_ONGLET_STYLE_SELECTIONNER_CENTER) + "'");
            } else {
                buf.append(" class='" + WelcomConfigurator.getMessage(WelcomConfigurator.CHARTEV2_ONGLET_STYLE_NON_SELECTIONNER_CENTER) + "'");
            }
            ...
            if (ongletSelected) {
                buf.append("'" + WelcomConfigurator.getMessage(WelcomConfigurator.CHARTEV2_ONGLET_STYLE_SELECTIONNER_RIGHT) + "'");
            } else {
                buf.append("'" + WelcomConfigurator.getMessage(WelcomConfigurator.CHARTEV2_ONGLET_STYLE_NON_SELECTIONNER_RIGHT) + "'");
            }
