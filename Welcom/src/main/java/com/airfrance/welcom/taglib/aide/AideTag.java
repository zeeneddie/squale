...
import com.airfrance.welcom.taglib.button.ButtonTag;

/**
 *  Generated tag class. Ce tag n'est pas renseigné dans la TLD de welcom
 */
public class AideTag extends BodyTagSupport {
    /**
     * 
     */
        ...
        if (type == null) {
            ...
            if (type.equals("ongletHiddenHyperlink")) {
                ...
                if (GenericValidator.isBlankOrNull(divOngletName)) {
                    throw new JspException("Aide Erreur : Type ongletTitreyperlink doit renseigner le propriété 'divOngletName'");
                }
                ...
                if (GenericValidator.isBlankOrNull(divOngletName)) {
                    throw new JspException("Aide Erreur : Type MenuHyperlinkOnglet doit renseigner le propriété 'divOngletName'");
                }
            } else {
                writeDefaultButton(results);
            }
     ...
     */
    private void writeDefaultButton(StringBuffer results) throws AideException {
        // Genere le tag de l'aide
        results.append("<a styleId=\"lien\" ");
