 ...
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public abstract class ColDisabled extends Col {
     ...
     */
    public abstract String getSpecificContent(final int position, final Object bean, final int idIndex, final String style, final String styleSelect, final int pageLength) throws JspException;
     ...
     * @return le html généré
     */
    public final String getCurrentValue(final int position, final Object bean, final int idIndex, final String style, final String styleSelect, final int pageLength) throws JspException {
     ...
     */
    private String getSpecificContent (String content,String style,boolean isNeedWriteWidth) throws JspException{
        final StringBuffer sb = new StringBuffer();
