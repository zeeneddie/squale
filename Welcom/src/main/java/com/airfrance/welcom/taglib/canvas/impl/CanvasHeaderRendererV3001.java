 ...
 */
public class CanvasHeaderRendererV3001 implements ICanvasHeaderRenderer {
    ...
    public StringBuffer drawHeader(String headerImageURL) {
        ...
        sb.append("<div id=\"header\" class=\"" + WelcomConfigurator.getMessage(WelcomConfigurator.CHARTEV3_HEADER_CIEL) + "\">");
