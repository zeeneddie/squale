 ...
 * CanvasPopupTag
 */
public class CanvasPopupTag extends CanvasBodyEventHandler {
    /**
     * 
     */
    ...
    /** render */
    private static ICanvasPopupRenderer render = (ICanvasPopupRenderer) RendererFactory.getRenderer(RendererFactory.CANVAS_POPUP);
