 ...
 *
 */
public class CanvasCenterTag extends TagSupport {
    /**
     * 
     */
    ...
    /** render */
    private static ICanvasCenterRenderer render = (ICanvasCenterRenderer) RendererFactory.getRenderer(RendererFactory.CANVAS_CENTER);
