...
public class TableTag extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            if (o == null) {
                final JspException e = new JspException("Objet " + name + "," + property + "introuvable dans le scope : " + scope + " ou l'objet est null");
    ...
    public int doEndTag() throws JspException {
        ...
        if ((!(collectionForDisplay.isEmpty()) || (collectionForDisplay.isEmpty() && !GenericValidator.isBlankOrNull(emptyKey))) && displayFooter) {
     ...
     */
    public void writeTableNavigation(final String pos) throws JspException {
	...
	/**
	 * @return retourne le message calculé
	 * Va voir en premier si on a definit une clef, alors recupere celle-ci, sinon, prend celle dans l'
	...
	private String getMessageComputed() {
		...
		if (!GenericValidator.isBlankOrNull(totalLabelKey)){
			...
			message = resources.getMessage(localeRequest, DEFAULT_TOTAL_LABEL_KEY, Integer.toString(collection.size()));
		}
     ...
     * @throws JspException exception pouvant etre levee
     */
    public void writePixGris() throws JspException {
