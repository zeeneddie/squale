 ...
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public class ColOrder extends Col implements ICol {
...
//    private boolean last = false;
    ...
    */
    public String getCurrentValue(final int position, final Object bean, final int idIndex, final String style, final String styleSelect, final int pageLength) {
    ...
    /**
     * Retourne la chaine construite avec le href. Si les parametres n'ont pas ete definis, on retourne l'action generique.
