 ...
 */
public class JSMenuTag extends TagSupport {
    /**
     * 
     */
        ...
        if (menu.hasChild()) {
            ...
            if (Util.isTrue(WelcomConfigurator.getMessage(WelcomConfigurator.WELCOM_MENU_LIGHT))) {
                ...
                if (WelcomConfigurator.getCharte() == Charte.V2_001) {
                    throw new JspException("Le menu light n'est pas utilisable avec la charte 001, mettre la cle welcom.menu.light a false");
                }
     ...
     * si un nom est spécifie alors retoune le nom
     * si un menu a deja été spécifié retourne "m2" et qu'il n'y a pas de nom spécifié
     * sinon retoune "m"
     ...
     */
    public String doPrintHeader() throws JspException {
