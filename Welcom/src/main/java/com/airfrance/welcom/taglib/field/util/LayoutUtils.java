 ...
 * d'appeler au démarrage de l'application la méthode statique init(ServletContext) qui permet de définir les attributs
 * de cette classe
 * 
 * @author: Cédric Torcq
 * @version 0.1
...
public class LayoutUtils
{
    ...
    protected static MessageResources menuMessages =
        MessageResources.getMessageResources( "com.airfrance.struts.taglib.menu.displayer.taglib.LocalStrings" );
    ...
    /**
     * Insérez la description de la méthode ici. Date de création : (02/08/2001 10:26:12)
     * 
