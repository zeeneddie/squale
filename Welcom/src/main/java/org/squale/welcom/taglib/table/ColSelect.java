    ...
    extends ColDisabled
{
                                      ...
                                      final String styleSelect, final int pageLength )
    {
        ...
        if ( bean instanceof WISelectable )
        {
            ...
            {
                result =
                    "Attention, le bean '" + bean.getClass()
                        + "' implémente déjà WISelectable, on ne tient donc pas compte de la property '"
                        + getProperty() + "'";
            }
        ...
        {
            result =
                "le bean '" + bean.getClass()
                    + "' doit implémenter WISelectable, ou l'attribut property du tag <ColSelect> doit être renseigner";
        }
