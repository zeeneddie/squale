    ...
    extends CanvasBodyEventHandler
{
    ...
    /** parametre du tag */
    private String canvasHeaderPageInclude =
        WelcomConfigurator.getMessage( WelcomConfigurator.BODY_CANVAS_HEADER_PAGE_INCLUDE );

    /** parametre du tag */
    private String canvasLeftPageInclude =
        WelcomConfigurator.getMessage( WelcomConfigurator.BODY_CANVAS_LEFT_PAGE_INCLUDE );

    /** clef du body */
    public static final String CANVASTAG_KEY = "org.squale.welcom.tag.body";
        ...
        throws JspException
    {
            ...
            && !Util.isEqualsIgnoreCase( canvasHeaderPageInclude, "none" ) )
        {
            ...
            final String path =
                pageContext.getServletContext().getRealPath( getAbsolutePathRelativeToContext( canvasHeaderPageInclude ) );
     ...
     * @throws JspException exception pouvant etre levee
     */
    private String doTraceur()
        throws JspException
    {
        String navigationMenuLabel =
            RequestUtils.message( super.pageContext, "org.apache.struts.action.MESSAGE",
