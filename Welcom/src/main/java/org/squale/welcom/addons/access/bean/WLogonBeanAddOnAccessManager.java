    ...
    implements WILogonBeanSecurity, Serializable
{
    ...
    // }
    /**
     * Spécifie le profil de l'utilisateur .. 1 profil = 1 user. RAZ des profils ...
     * 
    ...
    /**
     * @return Retourne le droit par defaut si non trouvé en BD (fichier excel) READWRITE,READONLY,NONE
     */
    ...
    /**
     * @param string droit par defaut si non trouvé en BD (fichier excel) READWRITE,READONLY,NONE
     */
