 ...
 * <p>Title : AbstractDAOImpl.java</p>
 * <p>Description : </p>
 * <p>Copyright : Copyright (c) 2004</p>
 * <p>Company : AIRFRANCE </p>
 * <br>
 * Classe de la couche DAO: propose une implémentation de l'interface d'accès à l'ORM pour le produit Hibernate
 * Il faut <b>impérativement</b> utiliser la méthode setBusinessClass dans le constructeur du DAO pour établir la valeur de la clause from des requetes HQL.
 * Par exemple pour une classe <b>EscaleDAOImpl</b> nous aurions le code:<br>
 * <b>	
 * <br>private EscaleDAOImpl() throws JrafDaoException {
 * <br>    <i> setBusinessClass(Escale.class);</i>
 * <br>}</b>
 */
public abstract class AbstractDAOImpl implements IPersistenceDAO {
	 ...
	 * On le cherche d'abord en cache session, auquel cas rien ne se passe
	 * <li>Si le mapping défini un  proxy (voir iterate), une référence est ajoutée.
	 * <li>Sinon l'objet est lue en base et caché dans la session
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#refresh(com.airfrance.jraf.spi.persistence.ISession, java.lang.Object)
	 */
	public void refresh(ISession session, Object obj) throws JrafDaoException {
		try {
	...
	/**
	 * Force la lecture complète de l'objet qq soit le mapping (lasy true)
	 * Si l'objet existe sous forme de proxy, il est remplacé par l'objet
	 * complet et mis en cache. 
	 * Si l'object existe déjà dans le cache, il n'est pas relu.
	 * @param session
	 * @param clazz
	 * @param id
	 * @return
	...
	/**
	 * Charge un objet depuis la base avec une relation (eager-fetching).
	 * Si l'objet est deja dans le cache des proxy, il est efface 
	 * puis repris de la base.
	 * @param session session de persistance
	...
	public Object getWithRelation(
		...
		try {
			...
			c.add(
				Expression.eq(
					getMetaData().getIdentifierName(getBusinessClass()),
					id));
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#find(com.airfrance.jraf.spi.persistence.ISession, java.lang.String)
	 */
	 ...
	 * Les paramametres sont passes sous forme de tableau dans l'ordre de la requete. 
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#find(com.airfrance.jraf.spi.persistence.ISession, java.lang.String, java.lang.Object)
	 */
	public java.util.List find(
		ISession session,
		String lRequete,
	 ...
	 */
	public List findAll(ISession session) throws JrafDaoException {
		SessionImpl sessionHibernate = (SessionImpl) session;
		List liste = null;
		try {
			liste =
				sessionHibernate.getSession().createQuery(getRequete()).list();
		} catch (Exception e) {
	...
	public java.util.List findWhere(ISession session, String whereClause)
		...
		try {
			liste =
				sessionHibernate
					.getSession()
					.createQuery(getRequete() + whereClause)
					.list();
		} catch (Exception e) {
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#findWhere(com.airfrance.jraf.spi.persistence.ISession, java.lang.String, java.lang.Object)
	 */
	public java.util.List findWhere(
		ISession session,
		String whereClause,
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#findWhereScrollable(com.airfrance.jraf.spi.persistence.ISession, java.lang.String, int, int, boolean)
	 */
	 ...
	 */
	public void create(ISession session, Object obj) throws JrafDaoException {
		SessionImpl sessionHibernate = (SessionImpl) session;
		try {
	 ...
	 */
	public void save(ISession session, Object obj) throws JrafDaoException {
		SessionImpl sessionHibernate = (SessionImpl) session;
		try {
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#remove(com.airfrance.jraf.spi.persistence.ISession, java.lang.Object)
	 */
	public void remove(ISession session, Object obj) throws JrafDaoException {
		SessionImpl sessionHibernate = (SessionImpl) session;
		try {
	 ...
	 */
	public void removeAll(ISession session) throws JrafDaoException {
		removeWhere(session, "");
	}
	...
	public int removeWhere(
		...
		try {
			Query query =
				sessionHibernate.getSession().createQuery(req + whereClause);
			query.setParameters(values, types);
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#removeWhere(com.airfrance.jraf.spi.persistence.ISession, java.lang.String, java.lang.Object)
	 */
	...
	* @param bean Bean ou sont lu les parametres de la requete  
	...
	/**
	 * Implémentation spécifique Hibernate<br>
	 * la variable requete contient la partie fixe de la requete OQL
	 * par exemple <b> from Avion as avion</b> pour un DAO de type AvionDAOImpl
	 * @return String
	 */
	...
	public Integer count(ISession session) throws JrafDaoException {
		...
		try {
			return (
				(Integer) sessionImpl
					.getSession()
					.createQuery("select count(*) " + getRequete())
					.iterate()
					.next());
		} catch (Exception e) {
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#countWhere(com.airfrance.jraf.spi.persistence.ISession, java.lang.String)
	 */
		...
		try {
			return (
				(Integer) sessionImpl
					.getSession()
					.createQuery(
						"select count(*) " + getRequete() + whereClause)
					.iterate()
					.next());
		} catch (Exception e) {
			throw new JrafDaoException(
	...
	* @param types Tableau des types hibernate des parametres de la requete (ex Hibernate.STRING) 
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#countWhere(com.airfrance.jraf.spi.persistence.ISession, java.lang.String, java.lang.Object)
	 */
	public Integer countWhere(
		ISession session,
		String whereClause,
	...
	/**
	 * Initialize le DAO
	 * Important : Cette methode ne doit etre appelee qu'une seule fois 
	 * lors de la creation d'une instance de DAO par le constructeur.
	...
	/**
	 * Initialize le DAO.
	 * Utilise le provider de persistance par défaut.
	 * Important : Cette methode ne doit etre appelee qu'une seule fois 
	 * lors de la creation d'une instance de DAO par le constructeur.
	 * @param clazz classe metier liee
	 */
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#findByExample(com.airfrance.jraf.spi.persistence.ISession, java.lang.Object, int, int, boolean, boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#findByExample(com.airfrance.jraf.spi.persistence.ISession, java.lang.Object, int, int, boolean, boolean, boolean)
	 */
	public List findByExample(
		ISession session,
		Object bo,
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#findByExample(com.airfrance.jraf.spi.persistence.ISession, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#findByExample(com.airfrance.jraf.spi.persistence.ISession, java.lang.Object, boolean, boolean)
	 */
	public List findByExample(
		ISession session,
		Object bo,
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#findByExample(com.airfrance.jraf.spi.persistence.ISession, java.lang.Object, int, int)
	 */
	public List findByExample(
		ISession session,
		Object bo,
	...
	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#findByExample(com.airfrance.jraf.spi.persistence.ISession, java.lang.Object, int, int, boolean)
	 */
	public List findByExample(
		ISession session,
		Object bo,
	...
	/**
	 * création d'une query à partir d'une requête sql, reprise d'une fonctionnalité d'Hibernate
	 * pour éviter d'avoir à importer les packages Hibernate dans les DAO de l'application
	 * cf API de la classe org.hibernate.Session
	 * @param session
	 * @param sql
	 * @return
	 */
	...
	public SQLQuery createSQLQuery(
		...
		Class returnClass) {
		SessionImpl sessionImpl = (SessionImpl) session;
		return sessionImpl.getSession().createSQLQuery(sql).addEntity(
			returnAlias,
			returnClass);
	}

	/* (non-Javadoc)
	 * @see com.airfrance.jraf.spi.persistence.IPersistenceDAO#loadFromSession(com.airfrance.jraf.spi.persistence.ISession, java.io.Serializable)
	 */
	public Object loadFromSession(ISession session, Serializable oid)
		...
		try {
			loaded =
				sessionHibernate.getSession().load(getBusinessClass(), oid);
