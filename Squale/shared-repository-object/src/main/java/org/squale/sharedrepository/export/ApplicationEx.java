...
public class ApplicationEx
{
    ...
    {
        modules = new ArrayList<ModuleEx>();
     ...
     * @param pAudit The audit {@link AuditEx}
     */
    public ApplicationEx( String pName, List<SegmentEx> pSegmentation, AuditEx pAudit, List<DataEx> pDatas,
                          List<ModuleEx> pModules )
    {
        name = pName;
     ...
     */
    public void setAudit( AuditEx pAudit )
    {
        audit = pAudit;
    }
