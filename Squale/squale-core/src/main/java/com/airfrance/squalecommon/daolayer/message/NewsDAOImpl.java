 ...
 */
public class NewsDAOImpl extends AbstractDAOImpl {
    /**
     * Instance singleton
     */
     ...
     */
    public Collection findWhereKind(ISession pSession, String pKind) throws JrafDaoException {
        ...
        if (pKind == null || (!pKind.equals("old") && !pKind.equals("current"))) {
            ...
            if (pKind.equals("old")) {
                ...
                if (pKind.equals("current")) {
                    whereClause +=  getAlias() + ".beginningDate < " + todayDate + "and " + getAlias() + ".endDate > " + todayDate;
                }
            }
     ...
     * @throws JrafDaoException en cas d'échec
     */
    public void removeNews(ISession pSession, NewsBO pNewsBO, MessageBO pMessBO) throws JrafDaoException {
     ...
     * @throws JrafDaoException en cas d'échec
     */
    public void addNews(ISession pSession, NewsBO pNewsBO, MessageBO pMessBO) throws JrafDaoException {
        MessageDAOImpl messDao = MessageDAOImpl.getInstance();
     ...
     * @throws JrafDaoException en cas d'échec
     */
    public void modifyNews(ISession pSession, NewsBO pNewsBO, MessageBO pMessBO) throws JrafDaoException {
        MessageDAOImpl messDao = MessageDAOImpl.getInstance();
     ...
     * @throws JrafDaoException en cas d'échec
     */
    public Collection findWhereNewsKeyIs(ISession pSession,String pKey) throws JrafDaoException {
