 ...
 *
 */
public class ProjectDAOImpl extends AbstractDAOImpl {
    /**
     * Instance singleton
     */
     ...
     */
    public Collection findWhere(ISession pSession, Long pAuditId) throws JrafDaoException {
     ...
     * Vérifie l'unicité du nom du projet pour l'application
     ...
     */
    public ProjectBO save(ISession pSession, ProjectBO pProject) throws JrafDaoException {
        LOG.debug(DAOMessages.getString("dao.entry_method"));
    ...
    /**
     * Création de l'objet métier persistent, <b>Attention : </b> la relation avec le projet doit être
     * à jour
     * @param pSession la session
     * @param pProject le projet à persister
     * @return le projet créé si tout s'est bien passé
     * @throws JrafDaoException si une erreur à lieu ou si le nom du projet existe déjà pour l'application correspondante
     */
    public ProjectBO create(ISession pSession, ProjectBO pProject) throws JrafDaoException {
        LOG.debug(DAOMessages.getString("dao.entry_method"));
    ...
    /**
         ...
         */
    public Collection findAllProjects(ISession pSession, Long pApplicationId) throws JrafDaoException {
        String whereClause = "where ";
     ...
     * @throws JrafDaoException si une erreur à lieu
     */
    private int countWhereParentName(ISession pSession, ProjectBO pProject) throws JrafDaoException {
        LOG.debug(DAOMessages.getString("dao.entry_method"));
        String whereClause = "where ";
     ...
     */
    public void remove(ISession pSession, Object pObj) throws JrafDaoException {
     ...
     */
    public void updateQualityGrid(ISession pSession, QualityGridBO pQualityGrid) throws JrafDaoException {
        String whereClause = "where ";
    ...
    /**
     * Retourne la liste des projets utilisant cette grille qualité
     * Sert notamment pour la notification aux gestionnaires des applications lors d'un chargement de nouvelle grille
     * @param pSession session
     * @param pQualityGridName grille qualité
     * @return l'ensemble des projets utilisant cette grille
     * @throws JrafDaoException si erreur
     */
    public Collection findWhereQualityGrid(ISession pSession, String pQualityGridName) throws JrafDaoException {
        String whereClause = "where ";
     ...
     * @throws JrafDaoException si erreur
     */
    public boolean isGridUsed(ISession pSession, Long pQualityGridId) throws JrafDaoException {
        String whereClause = "where ";
     ...
     */
    public Collection findWhereSourceManager(ISession pSession, Long pSourceManagerId) throws JrafDaoException {
    ...
    * @return une liste de ProjectBO
    */
    public Collection findWhereProfile(ISession pSession, Long pProfileId) throws JrafDaoException {
     ...
     */
    public Collection findProjects(ISession pSession, long[] pAppliIds, String pAppliName, String pProjectName) throws JrafDaoException {
     ...
     * @throws JrafDaoException en cas d'échec
     */
    public int countBySiteAndProfil(ISession pSession, long pSiteId, String pProfileName) throws JrafDaoException {
        int result = 0;
        // On construit la clause where afin que les comparaisons
        // de string ne prennent pas compte de la casse.
        String whereClause = "where " + getAlias() + ".parent.serveurBO.serveurId='" + pSiteId 
        + "' AND " + getAlias() + ".profile.name='" + pProfileName + "'";
        result = countWhere(pSession, whereClause).intValue();
        return result;
    }

    /**
     * Retourne tous les projets ayant le statut <code>pStatus</code> et rattaché à une application
     * <code>pSite</code> 
     * @param pSession la session
     ...
     */
    public Collection findWhereStatusAndSite(ISession pSession, int pStatus, long pSite) throws JrafDaoException {
        String whereClause = "where ";
        // le statut
     ...
     * @throws JrafDaoException si erreur
     */
    public ProjectParameterBO getParameterWhere(ISession pSession, Long pProjectId, String pKey) throws JrafDaoException {
        ...
        if(results.size() == 1) { // Il ne peut y avoir qu'un paramètre trouvé
