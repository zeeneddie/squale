 ...
 */
public class ProjectParameterDAOImpl extends AbstractDAOImpl {
    /**
     * Instance singleton
     */
     ...
     */
    public void create(ISession pSession, ProjectParameterBO pProjectParamBO) throws JrafDaoException {
     ...
     * @throws JrafDaoException en cas d'erreur
     */
    public void remove(ISession pSession, ProjectParameterBO pProjectParamBO) throws JrafDaoException {
     ...
     * @throws JrafDaoException en cas d'erreur
     */
    public Collection findWhere(ISession pSession, Long pParamId) throws JrafDaoException{
    ...
    /**
     * Met à jour les paramètres d'un projet en supprimant ses anciens paramètres
     * et en créant les nouveaux.
     * 
     * @param pSession une session hibernate
     * @param pParamId l'id des paramètres du projet
     ...
     * @throws JrafDaoException en cas d'erreur
     */
    public void removeAndCreateNew(ISession pSession, Long pParamId, ProjectParameterBO pParameters) throws JrafDaoException {
     ...
     * @throws JrafDaoException en cas d'erreur
     */
    public void removeParameters(ISession pSession, Long pProjectId) throws JrafDaoException {
