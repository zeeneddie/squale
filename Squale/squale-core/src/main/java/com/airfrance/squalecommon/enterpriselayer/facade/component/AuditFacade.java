...
/**
 */
public class AuditFacade implements IFacade {
     ...
     */
    public static void delete(AuditDTO pAudit) throws JrafEnterpriseException {
        delete(pAudit, null);
    }
     ...
     */
    public static AuditDTO get(AuditDTO pAudit) throws JrafEnterpriseException {
     ...
     */
    public static void delete(AuditDTO pAudit, ISession pSession) throws JrafEnterpriseException {
     ...
     */
    public static AuditDTO getLastAudit(ComponentDTO pApplication, String pAuditType) throws JrafEnterpriseException {
     ...
     */
    public static AuditDTO getPreviousAudit(AuditDTO pAudit, ISession pSession) throws JrafEnterpriseException {
        ...
        try {
            ...
            if (curAudit != null && appli != null) {
                AuditBO audit = auditDAO.findPreviousAudit(session, curAudit.getId(), curAudit.getHistoricalDate(), appli.getId(), null);
                if (audit != null) {
     ...
     * @throws JrafEnterpriseException exception JRAF
     */
    public static AuditDTO getLastAudit(ComponentDTO pApplication, String pAuditType, ISession pSession) throws JrafEnterpriseException {
        ...
        try {
            ...
            auditBO = auditDAO.getLastAuditByApplication(session, pApplication.getID(), pAuditType, AuditBO.TERMINATED);
     ...
     * @throws JrafEnterpriseException exception JRAF
     */
    public static List getFailedAudits(ComponentDTO pComponent, Integer pNbLignes, Integer pIndexDepart) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException exception JRAF
     */
    public static List getTerminatedAudits(ComponentDTO pComponent, Integer pNbLignes, Integer pIndexDepart) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException exception JRAF
     */
    public static List getAudits(ComponentDTO pComponent, Integer pNbLignes, Integer pIndexDepart, String pType, int pStatus) throws JrafEnterpriseException {
        // Initialisation
        ...
        try {
            ...
            auditBOs = auditDAO.findWhereComponent(session, pComponent.getID(), pNbLignes, pIndexDepart, pType, pStatus);
     ...
     */
    public static List getLastAudits(ComponentDTO pComponent, Integer pNbLignes, Integer pIndexDepart, String pType, int pStatus) throws JrafEnterpriseException {
     ...
     */
    public static Collection getAllAuditsAfterDate(Collection pApplications, Date pDate, boolean pWithFailedAudits) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException exception JRAF
     */
    private static Collection getAllAuditsAfterDate(ComponentDTO pApplication, Date pDate, boolean pWithFailedAudits) throws JrafEnterpriseException {
        // Initialisation
        List auditBOs = null; // retour de la DAO
        List auditDTOs = new ArrayList(); // retour de la facade
     ...
     * @return les audits pour les applications de pApplications dont l'exécution s'est effectué
     * après pDate (si ce paramètre n'est pas nul) et dont le statut n'est pas dans <code>pExcludedStatus</code>
     * @throws JrafEnterpriseException si erreur
     */
    public static Collection getAuditsForPortlet(Collection pApplications, Date pDate, Integer[] pExcludedStatus, String[] pExcludedApplications, Integer pNbAuditsPerAppli)
        ...
        try {
            ...
            auditBOs = auditDAO.findAfterDateWhereComponents(session, appliIds, pDate, pExcludedStatus, pNbAuditsPerAppli);
            if (0 == auditBOs.size()) {
                // On récupère le dernier audit effectué
                auditBOs = auditDAO.findAfterDateWhereComponents(session, appliIds, null, pExcludedStatus, new Integer(1));
            }
     ...
     */
    public static AuditDTO insertAudit(AuditDTO pAudit) throws JrafEnterpriseException {
     ...
     */
    public static AuditDTO insertAudit(AuditDTO pAudit, ISession pSession) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    private static AuditDTO insertNormalAudit(AuditDTO pAuditDTO, ISession pSession) throws JrafEnterpriseException {
    ...
    /**
     * Permet de reprogrammé un audit sur une application au lendemain.
     * si il s'agit d'un audit de suivi, l'audit déjà programmé est supprimé
    ...
    public static AuditDTO restartAudit(AuditDTO pAudit) throws JrafEnterpriseException {
        ...
        try {
            ...
            cal.add(GregorianCalendar.HOUR_OF_DAY, ApplicationFacade.HOUR_OF_AUDIT - cal.get(GregorianCalendar.HOUR_OF_DAY));
    ...
    /**
     * Insère un audit de suivi et supprime celui crée
     * normalement
     * @param pAudit l'audit de suivi à insérer
     * @return l'audit inséré ou null si l'insertion a échoué
     * @throws JrafEnterpriseException si erreur
     */
    private static AuditDTO restartNormalAudit(AuditDTO pAudit) throws JrafEnterpriseException {
        // Initialisation
        AuditDTO auditDTO = null; // retour de la facade
        AuditBO auditBO = null; // objet metier audit a ajouter
        ApplicationBO applicationBO = null; // projet relatif a l'audit
        ...
        try {
            ...
            if (applicationBO != null) {
                ...
                AuditBO nextAudit = auditDAO.getLastAuditByApplication(session, pAudit.getApplicationId(), pAudit.getType(), pAudit.getStatus());
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public static AuditDTO getMilestoneAudit(Long pApplicationId) throws JrafEnterpriseException {
        AuditDTO auditDTO = null;
        ISession session = null; // session hibernate
        try {
            session = PERSISTENTPROVIDER.getSession();
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public static AuditDTO modifyNextNormalAudit(long pApplicationId, AuditDTO pAuditDTO, ISession pSession) throws JrafEnterpriseException {
        AuditDTO lAuditDTO = null;
        ...
        try {
            ...
            lList = lAuditDAO.findWhereComponent(pSession, pApplicationId, null, null, AuditBO.NORMAL, AuditBO.NOT_ATTEMPTED);
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public static Integer removeAudit(Long pAuditId) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public static AuditDTO modifyAudit(AuditDTO pAudit) throws JrafEnterpriseException {
        AuditDTO auditDTO = null;
        ISession session = null; // session hibernate
        try {
            session = PERSISTENTPROVIDER.getSession();
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public static Collection getAudits(String pType, int pStatus) throws JrafEnterpriseException {
        // Initialisation
        List auditBOs = null; // retour de la DAO
        List auditDTOs = new ArrayList(); // retour de la facade
    ...
    /**
     * Permet de transformer un ensemble d'audits sous forme BO en DTO en récupérant au préalable
     ...
     */
    private static List bo2DtoWithApplication(ISession pSession, Collection pAuditBOs) throws JrafDaoException {
        List auditDTOs = new ArrayList(); // retour de la facade
        // Parcours de chaque audit et transformation de l'audit
        ...
        while (iterator.hasNext()) {
            ...
            ApplicationBO appliBO = ApplicationDAOImpl.getInstance().loadByAuditId(pSession, new Long(auditBO.getId()));
     ...
     * @throws JrafEnterpriseException exception Jraf
     */
    public static Integer updateAuditsDateOrStatus(Collection pAudits) throws JrafEnterpriseException {
        // Initialisation
        ISession session = null;
        int nbChanged = 0;
        try {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public static Collection getPartialAudits(ComponentDTO pComponent, Integer pNbLignes, Integer pIndexDepart) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public static AuditDTO getById(Long pAuditId) throws JrafEnterpriseException {
        ISession session = null;
        AuditDTO auditDTO = null;
        try {
            session = PERSISTENTPROVIDER.getSession();
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public static Collection getLastTerminatedAudits() throws JrafEnterpriseException {
     ...
     * @return les derniers audits des composants de type <pComponentType</code>
     * de type <code>pType</code> dont le status est <code>pStatus</code>
     * @throws JrafEnterpriseException si erreur
     */
    private static Collection getLastAudits(Class pComponentType, String pType, int pStatus) throws JrafEnterpriseException {
