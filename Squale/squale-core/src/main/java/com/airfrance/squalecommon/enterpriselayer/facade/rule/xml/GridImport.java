 ...
 */
public class GridImport extends XmlImport {
    /** Log */
    ...
    protected Digester setupDigester(GridFactory pGridFactory, StringBuffer pErrors) {
        ...
        configDigester.addBeanPropertySetter("squale/practiceset/practice/conditionformula/trigger", "triggerCondition");
        configDigester.addCallMethod("squale/practiceset/practice/conditionformula/conditions/condition", "addMarkCondition", 1);
        configDigester.addCallParam("squale/practiceset/practice/conditionformula/conditions/condition", 0);
        configDigester.addCallMethod("squale/practiceset/practice/conditionformula/measures/measure", "addMeasureKind", 1);
        ...
        configDigester.addCallMethod("squale/criteriumset/criterium/practice-ref", "addPractice", 2, new Class[]{PracticeRuleBO.class, Float.class});
        ...
        configDigester.addCallMethod("squale/factorset/factor/criterium-ref", "addCriterium", 2, new Class[]{CriteriumRuleBO.class, Float.class});
