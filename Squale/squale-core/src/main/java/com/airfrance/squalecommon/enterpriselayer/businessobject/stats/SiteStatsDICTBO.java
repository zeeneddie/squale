...
/**
 * La table regroupant les stats pour les indicateurs qui ne 
 * concernent pas le profil
 * 
 * @hibernate.class 
 * table="Stats_squale_dict"
 * mutable="true"
 */
public class SiteStatsDICTBO implements Serializable {
    ...
    public SiteStatsDICTBO(
        ...
        int pNbAppliExec,
        int pNbAppliSuccess,
        int pNbAppliWithoutAudits,
        int pNbAppliToValidate,
        int pFactorsAccepted,
        int pFactorsReserved,
        int pFactorsRefused,
        int pAuditsFailed,
        int pAuditsSuccessful,
        int pAuditsPartial,
        int pAuditsNotAttempted,
        double pRoi) {
     ...
     * 
     * @hibernate.property
     * name="nbOfAcceptedWithReservesFactors" 
     * column="NB_FACTEURS_ACCEPTES_RESERVES" 
     * type="integer" 
     * not-null="true" 
     * cascade="all"
     */
     ...
     * 
     * @hibernate.property
     * name="nbOfRefusedFactors" 
     * column="NB_FACTEURS_REFUSES" 
     * type="integer" 
     * not-null="true" 
     * cascade="all"
     */
     ...
     * 
     * @hibernate.property
     * name="nbTotalAppliWithAudit" 
     * column="NB_APPLI_AVEC_AUDIT_EXECUTE" 
     * type="integer" 
     * not-null="true" 
     * cascade="all"
     */
     ...
     * 
     * @hibernate.property
     * name="nbTotalAppliWithSuccesfulAudit" 
     * column="NB_APPLI_AVEC_AUDIT_REUSSI"  
     * type="integer" 
     * not-null="true" 
     * cascade="all"
     */
     ...
     * 
     * @hibernate.property
     * name="applisToValidate" 
     * column="NB_APPLI_A_VALIDER"  
     * type="integer" 
     * not-null="true" 
     * cascade="all" 
     */
     ...
     * 
     * @hibernate.property
     * name="notAttemptedAudits" 
     * column="NB_AUDITS_PROGRAMME"  
     * type="integer" 
     * not-null="true" 
     * cascade="all" 
     */
     ...
     * 
     * @hibernate.property
     * name="applisWithoutAudits" 
     * column="NB_APPLI_AVEC_AUCUN_AUDIT"  
     * type="integer" 
     * not-null="true" 
     * cascade="all" 
     */
