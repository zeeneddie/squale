 ...
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public class AuditTransform implements Serializable {
    ...
    /**
     * On ne spécifie pas l'id de l'audit, il sera mis plus tard car on l'a déjà au moment
     * où on appelle cette méthode
     * BO -> DTO pour un Audit
     * @param pAuditBO AuditBO
     * @return AuditDTO 
     */
