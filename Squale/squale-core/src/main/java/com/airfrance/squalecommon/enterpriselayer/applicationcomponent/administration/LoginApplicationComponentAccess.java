...
/**
 * <p>Title : LoginApplicationComponentAccess.java</p>
 * <p>Description : Application component login </p>
 * <p>Copyright : Copyright (c) 2005</p>
 * <p>Company : AIRFRANCE</p>
 */
public class LoginApplicationComponentAccess extends DefaultExecuteComponent {

    /**
     * Permet d'authentifier une utilisateur au sein d'AF
     * Vérifie aussi si l'utilisateur est administrateur portail
     ...
     */
    public UserDTO verifyUser(UserDTO pUser, Boolean pAdmin) throws JrafEnterpriseException {
     ...
     * Crée l'utilisateur dans la base de données le cas échéant
     * @param pUser objet UserDTO avec nom et email éventuellementy mis à jour
     * @param pAdmin indique si l'utilisateur a un privilège administrateur
     * @return <code>true</code> si l'utilisateur est correctement authentifié, sinon <code>false</code>
     * @throws JrafEnterpriseException exception JRAF
     */
    public UserDTO createOrUpdateUser(UserDTO pUser, Boolean pAdmin) throws JrafEnterpriseException {
     ...
     */
    public Collection getAdminsWithEmails(Boolean pUnsubscribed) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas de pb JRAF
     */
    public Collection getAdminsEmails(Boolean pUnsubscribed) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas de pb JRAF
     */
    public Collection getManagersWithEmails(Long pId, Boolean pUnsubscribed) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas de pb JRAF
     */
    public Collection getManagersEmails(Long pId, Boolean pUnsubscribed) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas de pb JRAF
     */
    public Collection getReadersWithEmails(Long pId, Boolean pUnsubscribed) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas de pb JRAF
     */
    public Collection getReadersEmails(Long pId, Boolean pUnsubscribed) throws JrafEnterpriseException {
