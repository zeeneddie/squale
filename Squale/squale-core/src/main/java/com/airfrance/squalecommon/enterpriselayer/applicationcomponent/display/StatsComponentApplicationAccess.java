...
/**
 */
public class StatsComponentApplicationAccess extends DefaultExecuteComponent {
     ...
     */
    public SetOfStatsDTO getStats(Integer pDaysForTerminatedAudit, Integer pDaysForAllAudits) throws JrafEnterpriseException{
