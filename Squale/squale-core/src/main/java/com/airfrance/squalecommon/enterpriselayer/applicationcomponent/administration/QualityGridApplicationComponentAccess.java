    ...
    extends DefaultExecuteComponent
{
     ...
     * @param deepTransformation le booléen indiquant si on veut également une transformation de la formule ou pas.
     ...
     * 
     * @param pQualityGrid grille
     * @return liste des métriques sous la forme de map, chaque entrée donnant le type de composant et la liste des
     *         métriques sur ce type de composant
     * @throws JrafEnterpriseException si erreur
     */
