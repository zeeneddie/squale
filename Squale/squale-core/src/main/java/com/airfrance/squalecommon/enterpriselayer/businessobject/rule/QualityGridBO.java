...
/**
 * Grille qualité
 * Une grille qualité est composée d'un ensemble de facteurs.
 * @hibernate.class 
 * table="QualityGrid"
 * mutable="true"
 * lazy="true"
 */
public class QualityGridBO  implements Serializable {
    /**
     ...
     *   class="com.airfrance.squalecommon.enterpriselayer.businessobject.config.ProjectProfileBO" 
     *   column="ProfileId"
     */
