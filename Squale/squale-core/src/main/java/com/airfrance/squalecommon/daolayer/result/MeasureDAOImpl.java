    ...
    extends AbstractDAOImpl
{
    ...
    /**
     * @param pSession la session
     * @param pApplicationId l'id de l'application dont on veut le ROI. Si il est à "-1" alors on veut le résultat pour
     *            toutes les applications
     * @param pStart la date du premier audit à récupèrer
     * @return la liste des mesures de ROI pour une application (ou toutes les applications) réalisées à partir de
     *         <code>pStart</code>
