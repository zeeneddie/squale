 ...
 */
public class AuditDateComparator implements Comparator {
    ...
    /**
     * @param pExecutedDate true si on compare selon le date d'exécution
     * false si on compare sur la date des sources
     */
