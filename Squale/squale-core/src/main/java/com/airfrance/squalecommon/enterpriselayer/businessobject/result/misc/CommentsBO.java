 ...
 * 
 * @hibernate.subclass
 * discriminator-value="Comments"
 */
public class CommentsBO extends MeasureBO{
    
    
    /**
     * Nombre de lignes de commentaires de la classe, i.e. nombre  
     * de lignes de commentaire pur et de commentaire mixte (code + 
     * commentaire)
     */
    private final static String CLOC="cloc";
    
    /**
     * Nombre total de lignes de code, y compris les commentaires, à 
     * l'exclusion des lignes blanches.
     */
    ...
    /**
     * Setter.
     * @param pCloc le nouveau nombre de ligne de commentaire 
     * de la classe
     */
    ...
    /**
     * Setter.
     * @param pSloc le nouveau nombre de lignes de code 
     * de la classe
     */
     ...
     * Getter.<br />
     * CLOC / SLOC * 100
     * @return le pourcentage global de lignes de 
     * commentaire d'un sous-projet.
     */
