 ...
 * Cette transformation est utilisée pour la construction du menu
 * top de façon dynamique
 */
public class GridMetricsTransform  implements QualityRuleBOVisitor {
     ...
     * @param pMeasureExtractor extracteur de mesure
     * le type de composant et en valer la liste des métriques
     */
