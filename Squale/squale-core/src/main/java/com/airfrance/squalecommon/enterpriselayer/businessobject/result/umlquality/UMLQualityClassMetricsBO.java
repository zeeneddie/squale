 ...
 * 
 * @hibernate.subclass
 * discriminator-value="UMLQualityClassMetrics"
 */
 
public class UMLQualityClassMetricsBO extends UMLQualityMetricsBO{
    ...
    /** Response For Class: nombre d'opérations qui peuvent être invoquées en réaction à un message reçu par une instance de cete classe.*/
