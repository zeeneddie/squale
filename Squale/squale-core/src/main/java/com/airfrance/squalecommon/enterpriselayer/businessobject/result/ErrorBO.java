...
public class ErrorBO implements Serializable {
    ...
    /**
     * Message traduit en version Squale si possible : il s'agit en fait de sa clé 
     ...
     */
    public ErrorBO(String pInitialMessage, String pMessage, String pLevel, String pTaskName, AuditBO pAudit, ProjectBO pProject) {
        mId = -1;
        mInitialMessage = pInitialMessage;
        mMessage = pMessage;
        mLevel = pLevel;
