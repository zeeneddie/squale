...
/**
 */
public class MethodDAOImpl extends AbstractDAOImpl {
    /**
     * Instance singleton
     */
     ...
     */
    public Collection findMethodeByName(ISession pSession, String pMethodName, String pFileName, long pAuditId) throws JrafDaoException {
        ...
        String query = "select " + getAlias() + " from " + classAuditName + " as " + auditAlias + ", " + className + " as " + getAlias() + " ";
        String whereClause =
            "where " + getAlias() + ".longFileName='" + pFileName + "' AND " + getAlias() + ".name like '" + pMethodName + "%' AND " + getAlias() + " in elements(" + auditAlias + ".components) ";
