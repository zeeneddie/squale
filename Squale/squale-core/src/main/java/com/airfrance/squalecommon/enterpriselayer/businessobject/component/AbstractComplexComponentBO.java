 ...
 * @hibernate.subclass
 * lazy="true"
 * discriminator-value="AbstractComplexComponent"
 */
public abstract class AbstractComplexComponentBO extends AbstractComponentBO {
     ...
     * 
     * @hibernate.bag 
     * table="AbstractComplexComponent_children" 
     * lazy="true" 
//     * cascade="save-update" 
     * inverse="true"
     * 
