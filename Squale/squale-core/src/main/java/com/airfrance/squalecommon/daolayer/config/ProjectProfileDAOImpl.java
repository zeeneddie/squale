 ...
 */
public class ProjectProfileDAOImpl extends AbstractDAOImpl {
     ...
     */
    public void removeOthers(ISession pSession, Collection pProfiles) throws JrafDaoException {
     ...
     * @throws JrafDaoException si erreur
     */
    public ProjectProfileBO findWhereName(ISession pSession, String pName) throws JrafDaoException {
    ...
    /**
     * Renvoit les profils présents en base mais non présents dans la liste
     * donnée en paramètre
     * 
     ...
     * @throws JrafDaoException si erreur
     */
    public Collection findOthers(ISession pSession, Collection pProfiles) throws JrafDaoException {
        StringBuffer whereClause = new StringBuffer("where ");
        whereClause.append(getAlias());
        whereClause.append(".name not in(");
        Iterator profilesIt = pProfiles.iterator();
     ...
     * @throws JrafDaoException si erreur
     */
    public Collection findProfiles(ISession pSession) throws JrafDaoException {
        String whereClause = "";
