 ...
 *
 */
public class ErrorDAOImpl extends AbstractDAOImpl {
    /**
     * Instance singleton
     */
     ...
     */
    public void removeWhereAudit(ISession pSession, AuditBO pAudit) throws JrafDaoException {
     ...
     * @throws JrafDaoException si une erreur à lieu
     */
    public void removeWhereProject(ISession pSession, ProjectBO pProjet) throws JrafDaoException {
        String whereClause = "where ";
    ...
    /**
     * Permet de recuperer une collection de ErrorBO pour un audit et une liste 
     * de noms de taches donnés
     ...
     */
    public Collection findWhere(ISession pSession, Long pAuditID, Long pProjectId, Collection pTasks, Integer pNbLignes, Integer pIndexDepart) throws JrafDaoException {
        List errors;
     ...
     * @throws JrafDaoException exception Dao
     */
    public Collection findWhereAuditAndTasks(ISession pSession, Long pAuditID, Long pProjetId, Collection pTasks) throws JrafDaoException {
     ...
     */
    public void create(ISession pSession, ErrorBO pError) throws JrafDaoException {
     ...
     */
    public Integer getNumberOfErrorsWhere(ISession pSession, Long pAuditId, Long pProjectId, String pLevel) throws JrafDaoException {
     ...
     * @throws JrafDaoException en cas d'échec
     */
    public List getTasksNameWhere(ISession pSession, Long pAuditId, Long pProjectId, String pLevel) throws JrafDaoException {
