 ...
 *
 */
public class CheckstyleFacade implements IFacade {
    ...
    */
    ...
    public static ArrayList getAllVersions() throws JrafEnterpriseException {
    ...
    /**
     * Insert une nouvelle version du fichier de configuration checkstyle.
     * Et assure l'ascendance de la nouvelle version vers les anciennes
    ...
    public static CheckstyleDTO importCheckstyleConfFile(InputStream pStream, StringBuffer pErrors) throws JrafEnterpriseException {
        ...
        try {
            ...
            CheckstyleRuleSetBO versionBo = checkstyleImport.importCheckstyle(new ByteArrayInputStream(bytes), pErrors);
