 ...
 * 
 * @hibernate.subclass
 * discriminator-value="PracticeResult"
 */
public class PracticeResultBO extends QualityResultBO {
     ...
     * 
     * @hibernate.array 
     * table="PracticeResult_Repartition"
     * cascade="none"
     * 
     * @hibernate.collection-key 
     * column="PracticeResultId"
     * 
    ...
    /**
     * Augmente de un la valeur de la répartition pour la note pMark :
     *  mRepartition[findIndex(pMark)] = mRepartition[findIndex(pMark)] + 1
    ...
    /**
     * Retourne un tableau de répartitions pour des intervalles de notes de pas = 1
     * 5 cases: 0 <= note <1, 1<= note <2, 2<= note <3 , note = 3, composants non notés
