...
/**
 * Cette classe va servir pour faire le lien entre la récupération des infos dans les taches externes
 * et l'enregistrement dans la base de donnée
 * 
 * @hibernate.subclass
 * discriminator-value="ExtBugTrackingMetrics"
 * 
 */
public class ExtBugTrackingMetricsBO extends MeasureBO {
