 ...
 * Trois profils sont identifiés actuellement : utilisateur, gestionnaire (administrateur de projet), 
 * administrateur (super adminitrateur).
 * + profil defaut
 * @author m400842
 * 
 * @hibernate.class 
...
public class ProfileBO implements Serializable {
     ...
     * Les droits Welcom sont les clés, et l'action la valeur : READONLY, READWRITE, 
     * NONE.
     */
    private Map mRights;
