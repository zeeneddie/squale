 ...
 */
public class RoiComponentAccess extends DefaultExecuteComponent {
     ...
     */
    public RoiDTO updateFormula(RoiDTO pRoiDto, StringBuffer pErrors) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public RoiDTO getROI(Long pApplicationId) throws JrafEnterpriseException {
