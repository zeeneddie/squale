...
/**
 * Paramètre d'une formule
 * Une formule utilise des paramètres avec la syntaxe xxx.yyy où xxx
 * représente un type de mesure et yyy l'attribut de la mesure
 * Par exemple mccabe.maxvg
 */
public class FormulaParameter {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FormulaParameter) {
            ...
            result = parameter.getMeasureKind().equals(getMeasureKind()) &&
