 ...
 * @hibernate.subclass
 * lazy="true"
 * discriminator-value="UmlModel"
 */
public class UmlModelBO extends AbstractComplexComponentBO{
     ...
     * 
     */
    public UmlModelBO(String pName, Collection pChildren, AbstractComplexComponentBO pParent) throws UnexpectedRelationException {
