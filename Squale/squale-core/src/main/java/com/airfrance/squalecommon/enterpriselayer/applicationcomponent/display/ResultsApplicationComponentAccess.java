 ...
 * <p>Title : ResultsApplicationComponentAccess.java</p>
 * <p>Description : Application component d'affichage de resultats</p>
 * <p>Copyright : Copyright (c) 2005</p>
 * <p>Company : AIRFRANCE</p>
 * @author m400841
 */
public class ResultsApplicationComponentAccess extends DefaultExecuteComponent {
     ...
     * @param pAudit AuditDTO renseignant l'ID de l'audit sinon <code>null</code> pour 
     * le dernier audit de suivi
     ...
     * @return ResultsDTO <br/>
     * Format de ResultsDTO : 2 lignes : <br/>
     * -- Clé : null -- Valeur : liste des clés des TREs<br/>
     * -- Clé : ComponentDTO -- Valeur : liste des résultats associées en valeur
     * @throws JrafEnterpriseException Exception JRAF
     * @roseuid 42CBFBFD0008
     */
    public ResultsDTO getComponentResults(AuditDTO pAudit, ComponentDTO pComponent, Boolean pMetrics) throws JrafEnterpriseException {
        // Initialisation 
     ...
     */
    public Collection getAllPractices(AuditDTO pAudit, ComponentDTO pProject) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public Collection getAllPracticeNames(AuditDTO pAudit, ComponentDTO pProject) throws JrafEnterpriseException {
     ...
     * @param pAuditDTOs liste des IDs des audits. Si <code>null</code> alors recuperation des
     * deux derniers audits de suivi
     * @return ResultsDTO <br/>
     * Format de ResultsDTO : 2 lignes : <br/>
     * -- Clé : null -- Valeur : liste des AuditDTOs<br/>
     * -- Clé : ComponentDTO -- Valeur : liste des résultats associées<br/>
     * @throws JrafEnterpriseException Exception JRAF
     * @roseuid 42CBFBFD01E9
     */
    public ResultsDTO getByAudit(List pAuditDTOs, ComponentDTO pProject, Long pRuleId) throws JrafEnterpriseException {
     ...
     * @param pAudit AuditDTO renseignant l'ID de l'audit. Si <code>null</code> passé en parametre,
     * alors recuperation des deux derniers audits de suivi.
     * @param pComponentDTOs liste des IDs des composants
     * @return ResultsDTO <br/>
     * Format de ResultsDTO : n+1 lignes : <br/>
     * -- Clé : null -- Valeur : liste des clés de TREs <br/>
     * -- Clé : ComponentDTO -- Valeur : liste des résultats associées ( n fois ) <br/>
     * @throws JrafEnterpriseException Exception JRAF
     * @roseuid 42CBFBFD0289
     */
    private ResultsDTO getByFactorAndProject(AuditDTO pAudit, List pComponentDTOs) throws JrafEnterpriseException {
        // Initialisation
     ...
     * @param pProject ComponentDTO renseignant l'ID du composant
     * @param pAuditDTOs liste des IDs des audits. Si <code>null</code> passé en parametre,
     * alors recuperation des deux derniers audits de suivi.
     * @return ResultsDTO <br/>
     * Format de ResultsDTO : n+1 lignes : <br/>
     * -- Clé : null -- Valeur : liste des clés de TREs <br/>
     * -- Clé : AuditDTO -- Valeur : liste des résultats associées en valeur ( n fois ) 
     * @throws JrafEnterpriseException Exception JRAF
     * @roseuid 42CBFBFD030B
     */
    public ResultsDTO getProjectResults(List pAuditDTOs, ComponentDTO pProject) throws JrafEnterpriseException {
     ...
     */
    public AuditGridDTO getProjectAuditGrid(ComponentDTO pProject, AuditDTO pAudit) throws JrafEnterpriseException {
     ...
     * Format de ResultsDTO : n+1 lignes : <br/>
     * -- Clé : null -- Valeur : liste des clés de TREs <br/>
     * -- Clé : ComponentDTO -- Valeur : liste des résultats associées en valeur ( n fois ) 
     * @throws JrafEnterpriseException Exception JRAF
     */
    public ResultsDTO getProjectVolumetry(Long pAuditId, ComponentDTO pProject) throws JrafEnterpriseException {
     ...
     * @param pNbLignes nombre de lignes, sinon <code>null</code> pour tous les projets
     * avec le parametre pIndexDepart à <code>null</code>
     ...
     * @throws JrafEnterpriseException Exception JRAF
     */
    public Collection getReference(Integer pNbLignes, Integer pIndexDepart, Boolean pIsAdmin, Long pUserId) throws JrafEnterpriseException {
        Collection collection = null;
        collection = SqualeReferenceFacade.getProjectResults(pNbLignes, pIndexDepart, pIsAdmin.booleanValue(), pUserId);
        return collection;
    }
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public List getApplicationResults(Collection pComponentDTOs) throws JrafEnterpriseException {
        ...
        while (componentIterator.hasNext()) {
            ...
            Iterator children = new ArrayList(ComponentFacade.getChildren(currentComponent, null, null, null)).iterator();
     ...
     * @param pAudits liste des audits souhaités, sinon <code>null</code> pour le cas ou on souhaite
     * les deux derniers audits (paramétré dans le fichier de propriétés)
     * @return liste de liste de resultDTOs triés dans le meme ordre que les pComponentDTOs<br/>
     * Format de la liste : <br/>
     * liste de liste - le nombre d'élément étant égal au nombre d'éléments de pComponentDTOs
     * {ResultsDTO du dernier audit, ResultsDTO de l'avant-dernier audit, etc. }<br/><br/>
     * Format du ResultsDTO :<br/>
     * -- Clé : null -- Valeur : liste des TREs disponibles<br/>
     * -- Clé : ComponentDTO relatif au projet -- Valeur : liste de valeurs associés (n fois)
     * (n fois avec n le nombre total de projets appartenant a l'utilisateur)
     * @throws JrafEnterpriseException Exception JRAF
     * @roseuid 42CBFBFE0154
     */
    public List getApplicationResults(Collection pComponentDTOs, List pAudits) throws JrafEnterpriseException {
     ...
     * @return résultats vides respectant le format suivant :
     * -- Clé : null -- Valeur : liste des TREs demandés<br/>
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public Boolean getHaveErrors(Long pAuditId, Long pProjectId) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public Integer getNumberOfErrors(Long pAuditId, Long pProjectId) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public Integer[] getErrorsRepartition(Long pAuditId, Long pProjectId) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public List getFailedTasks(Long pAuditId,Long pProjectId) throws JrafEnterpriseException {
        return ErrorFacade.getFailedTasks(pAuditId, pProjectId);
    }

    /**
     * Ajoute à pResultDTOs les ResultDTO correspondant.Recupere pour tous les audits
     * les ResultsDTO au format composant en fonction des tres, et les ajoute a la liste de ResultsDTO
     ...
     * @throws JrafEnterpriseException Exception JRAF
     */
    private List getProjectResultList(List pResultDTOs, List pCurrentAudits, List pChildren) throws JrafEnterpriseException {
        ...
        while (auditIterator.hasNext() && pResultDTOs != null) {
            ...
            /* TODO tester que la premiere ligne de resultsDTO pour chaque projet est la meme
     ...
     * @return ResultsDTO du format suivant :<br />
     * -- Clé : null -- Valeur : liste des clés de TREs<br />
     * -- Clé : AuditDTO -- Valeur : liste des résultats associées ( n fois )<br />
     * @throws JrafEnterpriseException exception Jraf
     */
    public ResultsDTO getTreChildrenResults(ComponentDTO pComponent, Long pTreParent, List pAudits) throws JrafEnterpriseException {
     ...
     * -- Clé : ComponentDTO -- Valuer : valeurs associé au tre <br/>
     * <br/>
     * PracticeMap : n lignes de la forme suivante :<br/>
     * -- Clé : AuditDTO -- Valeur : tableau de Integer correspondant a la repartition
     * @throws JrafEnterpriseException exception Jraf
     */
    public ResultsDTO getRepartitionResults(List pAudits, ComponentDTO pProject, PracticeRuleDTO pPractice) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException exception Jraf
     */
    public ResultsDTO getRuleCheckingResults(List pAudits, ComponentDTO pProject, PracticeRuleDTO pPractice) throws JrafEnterpriseException {
        // Initialisation
        ResultsDTO repartitionResults = null; // retour de la methode
        ComponentDTO currentComponent = validateComponent(pProject); // composant testé
        List currentAudits = null; // audits initialises
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public Collection getRuleCheckingItemResults(Long pMeasureID, Long pRuleID) throws JrafEnterpriseException {
        return QualityResultFacade.getRuleCheckingItems(pMeasureID, pRuleID);
    }

    /**
     * Permet de recuperer les composants et leurs resultats associés a une valeur donnée 
     * d'une note et un audit
     ...
     * @return ResultsDTO de la forme suivante :<br/>
     * -- Clé : null -- Valeur : Liste de clés de tre relatifs a une pratique
     * -- Clé : ComponentDTO -- Valeur : Liste de valeur associée
     * @throws JrafEnterpriseException exception Jraf
     */
    public ResultsDTO getValueResults(AuditDTO pAudit, ComponentDTO pProject, Long pTreKey, Integer pValue, Integer pMax) throws JrafEnterpriseException {
    ...
    /**
         ...
         * @throws JrafEnterpriseException exception Jraf
         */
    public ResultsDTO getValueResultsForInterval(AuditDTO pAudit, ComponentDTO pProject, Long pTreKey, Double pMinValue, Double pMaxValue, Integer pMax) throws JrafEnterpriseException {
        ...
        if (pMinValue != null && pMaxValue != null) {
            ...
            components = ComponentFacade.getComponentsInInterval(pAudit, currentProject, pTreKey, pMinValue, pMaxValue, pMax);
            treChildren = ComponentFacade.getTREChildren(pTreKey);
     ...
     */
    public AuditDTO getPreviousAudit(AuditDTO pAudit) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException exception Jraf
     */
    public ResultsDTO getTopResults(ComponentDTO pProject, String pComponentType, AuditDTO pAudit, String pTre, Integer pMax) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException exception Jraf
     */
    private AuditDTO initAudit(AuditDTO pAudit, ComponentDTO pComponent) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException exception Jraf
     */
    private List initAuditList(List pAudits, ComponentDTO pComponent) throws JrafEnterpriseException {
    ...
    private List validateComponents(List pComponents) {
        ...
        if (pComponents != null) {
            ...
            while ((componentIterator.hasNext()) && (components != null)) {
                ...
                } else { // objets differents de ComponentDTO
                    components = null;
                }
            }
        } else {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public Collection getChangedComponentResults(AuditDTO firstAudit, AuditDTO secondAudit, ComponentDTO project, Object[] filter, Integer pLimit) throws JrafEnterpriseException {
        ...
        Collection components = QualityResultFacade.getChangedComponents(firstAudit, secondAudit, project, filter, pLimit);
        return components;
    }
     ...
     * @return les 100 (au maximum) composants ou transgressions "à corriger" (si <code>pHasLimit</code>)
     * triés par pratique (de la pratique la plus facile à corriger à la moins facile).
     * Une pratique est plus facile à corriger si l'effort * nombre de corrections à faire est bas.
     * @throws JrafEnterpriseException si erreur
     */
    public Collection getWorstPractices(String pAuditId, String pProjectId, Boolean pHasLimit) throws JrafEnterpriseException {
