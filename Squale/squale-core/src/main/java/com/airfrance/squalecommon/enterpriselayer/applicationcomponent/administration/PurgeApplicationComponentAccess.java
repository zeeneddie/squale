...
/**
 * <p>Title : PurgeApplicationComponentAccess.java</p>
 * <p>Description : Application component pour la purge projet et audit </p>
 * <p>Copyright : Copyright (c) 2005</p>
 * <p>Company : AIRFRANCE</p>
 */
public class PurgeApplicationComponentAccess extends DefaultExecuteComponent {
     ...
     */
    public Integer purgeApplication(ApplicationConfDTO pApplicationConf) throws JrafEnterpriseException {
     ...
     */
    public Integer purgeAudit(AuditDTO pAudit) throws JrafEnterpriseException {
        Integer status = new Integer(0);
        ISession session = null;
        try {
            session = PERSISTENTPROVIDER.getSession();
