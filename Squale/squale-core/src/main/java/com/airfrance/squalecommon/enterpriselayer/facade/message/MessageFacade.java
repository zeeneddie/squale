...
public class MessageFacade {
     ...
     * Les messages existants sont mis à jour si besoin, ils ne sont pas supprimés
     * @param pStream flux
     * @param pErrors erreurs
     * @return messages
     * @throws JrafEnterpriseException si erreur
     */
    public static MessagesDTO importMessages(InputStream pStream, StringBuffer pErrors) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public static MessagesDTO getMessages() throws JrafEnterpriseException {
        MessagesDTO result = null;
        ISession session = null;
        try {
            // récupération d'une session
     ...
     * le premier niveau de map étant basé sur la langue et le deuxième sur
     * la clef du message (le texte étant la valeur)
     * @return messages
     */
     ...
     */
    public static NewsListDTO getNews(String pKind,String pLang) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public static void purgeNews(NewsDTO newsDto) throws JrafEnterpriseException {
        ISession session = null;
        try {
            session = PERSISTENTPROVIDER.getSession();
            NewsDAOImpl dao = NewsDAOImpl.getInstance();
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public static void addNews(NewsDTO pNewsDto) throws JrafEnterpriseException {
        ISession session = null;
        try {
            session = PERSISTENTPROVIDER.getSession();
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public static void modifyNews(NewsDTO pNewsDto) throws JrafEnterpriseException {
        ISession session = null;
        try {
            session = PERSISTENTPROVIDER.getSession();
            MessageBO messBO = MessageTransform.dto2Bo(pNewsDto.getMessage());
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public static Collection findLangs() throws JrafEnterpriseException {
        ISession session = null;
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public static Boolean newsAlreadyExists(String pKey) throws JrafEnterpriseException {
        ISession session = null;
        Collection coll = null;
        try {
            session = PERSISTENTPROVIDER.getSession();
