 ...
 */
public class AbstractDisplayConfDAOImpl extends AbstractDAOImpl {
     ...
     */
    public List findAllSubclass(ISession pSession, Class pSubclass) throws JrafDaoException {
     ...
     */
    public void removeUnusedConf(ISession pSession) throws JrafDaoException {
