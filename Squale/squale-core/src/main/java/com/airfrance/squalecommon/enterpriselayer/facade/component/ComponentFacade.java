    ...
    implements IFacade
{
     ...
     *            sont retournés pour tout les audits
    ...
    /**
     * Permet de recuperer une liste de composants qui possede une valeur donnée pour une note donnée
     * 
     ...
     * @return List de ComponentDTO parents en ordre hiérarchique et ne comprenant pas le projet ni l'application
     */
        ...
        throws JrafEnterpriseException
    {
        ...
        try
        {
            ...
            // à jour. On ne procède pas avec un transformer car le ComponentDTO et le AbstractComponentBO n'ont pas la
            // meme structure,
