...
public class StatsFacade {
     ...
     * réussi pour que l'application soit active (sert pour les statistiques par application)
     * @param pDaysForAllAudits le nombre de jours défini pour compter les audits 
     * (sert pour les staistiques par application)
     ...
     */
    public static SetOfStatsDTO getStats(int pDaysForTerminatedAudit, int pDaysForAllAudits) throws JrafEnterpriseException {
     ...
     */
    private static List getApplicationsStats(int pDaysForTerminatedAudit, int pDaysForAllAudits) throws JrafEnterpriseException {
