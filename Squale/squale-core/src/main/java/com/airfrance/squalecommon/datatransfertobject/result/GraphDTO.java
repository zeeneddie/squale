...
/**
 Permet de contenir une image qui peut être :
 - une courbe des tendances
 - un kiviat
 - un scatterplot
 */
public class GraphDTO implements Serializable {
    ...
    /**
     * Identifiant de l'audit associé, 
     * -1 si pas de liasion spécifique (ex : Histo)
     */
    private long mIDAudit;
    
    /**
     * Identifiant du composant associé, 
     * -1 si pas de liasion spécifique (ex : Histo)
     */
