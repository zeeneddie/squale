//Source file: D:\\CC_VIEWS\\SQUALE_V0_0_ACT\\SQUALE\\SRC\\squaleCommon\\src\\com\\airfrance\\squalecommon\\enterpriselayer\\applicationcomponent\\ApplicationAdminApplicationComponentAccess.java
...
/**
 * <p>Title : ApplicationAdminApplicationComponentAccess.java</p>
 * <p>Description : Application component de configuration du projet </p>
 * <p>Copyright : Copyright (c) 2005</p>
 * <p>Company : AIRFRANCE</p>
 */
public class ApplicationAdminApplicationComponentAccess extends DefaultExecuteComponent {
     ...
     */
    public Integer addProject(ProjectConfDTO pProjectConf, ApplicationConfDTO pApplicationConf) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException Exception JRAF
     */
    public Integer saveApplication(ApplicationConfDTO pApplicationConf) throws JrafEnterpriseException {
        Integer status = new Integer(0);
        ISession session = null;
        try {
            session = PERSISTENTPROVIDER.getSession();
     ...
     */
    public void updateLastModifParams(Long pApplicationId, String pLastUser, Date pLastUpdate) throws JrafEnterpriseException {
     ...
     */
    public ApplicationConfDTO createApplication(ApplicationConfDTO pApplicationConf, UserDTO pUserCreating) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException Exception JRAF
     */
    public ProjectConfDTO removeProject(Long pProjectId) throws JrafEnterpriseException {
        // Initialisation
        ISession session = null;
     ...
     * @throws JrafEnterpriseException Exception JRAF
     */
    public ProjectConfDTO disactiveOrReactiveProject(Long pProjectId) throws JrafEnterpriseException {
        // Initialisation
        ISession session = null;
        ProjectConfDTO result = null;
        try {
     ...
     */
    public ProjectConfDTO saveProject(ProjectConfDTO pProjectConf, ApplicationConfDTO pApplicationConf) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException Exception JRAF
     */
    public AuditDTO addMilestone(AuditDTO pAudit) throws JrafEnterpriseException {
     ...
     */
    public AuditDTO addBranch(AuditDTO pAuditDTO) throws JrafEnterpriseException, JrafPersistenceException {
     ...
     */
    public ApplicationConfDTO getApplicationConf(ApplicationConfDTO pApplicationConf) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public AuditDTO restartAudit(AuditDTO pAudit) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public AuditDTO getMilestoneAudit(Long pApplicationId) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public Integer removeAudit(Long pAuditId) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public AuditDTO modifyAudit(AuditDTO pAudit) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public void addUserAccess(Collection pApplications, String pMatricule, Integer maxSize) throws JrafEnterpriseException {
        try {
            ISession session = PERSISTENTPROVIDER.getSession();
            session.beginTransaction();
