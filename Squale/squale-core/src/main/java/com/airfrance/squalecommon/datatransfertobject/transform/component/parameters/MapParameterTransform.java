        ...
        for(Iterator it = keys.iterator(); it.hasNext();) {
            ...
            if(paramsDTO.get(currentKey) instanceof MapParameterDTO) {
                ...
                if(paramsDTO.get(currentKey) instanceof ListParameterDTO) {
                    paramsBO.put(currentKey, ListParameterTransform.dto2Bo((ListParameterDTO)paramsDTO.get(currentKey)));
                }else {
                    if(paramsDTO.get(currentKey) instanceof StringParameterDTO) {
                        paramsBO.put(currentKey, StringParameterTransform.dto2Bo((StringParameterDTO)paramsDTO.get(currentKey)));
                    }
                }
            }
        }
        ...
        for(Iterator it = keys.iterator(); it.hasNext();) {
            ...
            if(paramsBO.get(currentKey) instanceof MapParameterBO) {
                ...
                if(paramsBO.get(currentKey) instanceof ListParameterBO) {
                    paramsDTO.put(currentKey, ListParameterTransform.bo2Dto((ListParameterBO)paramsBO.get(currentKey)));
                }else {
                    if(paramsBO.get(currentKey) instanceof StringParameterBO) {
                        paramsDTO.put(currentKey, StringParameterTransform.bo2Dto((StringParameterBO)paramsBO.get(currentKey)));
                    }
                }
            }
        }
