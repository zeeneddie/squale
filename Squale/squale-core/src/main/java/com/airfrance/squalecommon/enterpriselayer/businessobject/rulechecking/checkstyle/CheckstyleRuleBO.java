 ...
 * Règle checkstyle
 * @hibernate.subclass
 * discriminator-value="Checkstyle"
 */
public class CheckstyleRuleBO extends RuleBO {
     ...
     * class="com.airfrance.squalecommon.enterpriselayer.businessobject.rulechecking.checkstyle.CheckstyleModuleBO" 
     */
     ...
     * @throws MismatchSeverityException si l'attribut severity du module est incohérent avec la sévérité
     * de la règle
     */
    public void addModule(CheckstyleModuleBO pModule) throws MissingSeverityException, MismatchSeverityException{
        
        if (pModule.getSeverity() != null) {

            if ((mSeverity == null)) {// première module à être regroupée sous cette regle interne
   ...
   /**
    * Exception de sévérité manquante
    * Levée lorsque l'attribut severity est absent
    */
   public class MissingSeverityException extends Exception {
   }
   /**
    * Exception d'incohérence de sévérité
    * Levée lorsque la sévérité d'un module checkstyle est incompatible
    * avec celle de la règle checkstyle
    */
   public class MismatchSeverityException extends Exception {
   }
}
