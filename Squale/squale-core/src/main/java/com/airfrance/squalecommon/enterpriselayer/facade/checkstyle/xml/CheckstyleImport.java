 ...
 * 
 */
public class CheckstyleImport extends XmlImport {
    ...
    protected Digester setupDigester(CheckstyleRuleSetFactory pRuleSetFactory, StringBuffer pErrors) {
        ...
        configDigester.addCallMethod("module/module/module/property","addProperty",2,new Class[]{String.class,String.class});
        ...
        CheckstyleRuleFactory  checkstyleRuleFactory=new  CheckstyleRuleFactory(pRuleSetFactory, checkstyleRulePractice);
