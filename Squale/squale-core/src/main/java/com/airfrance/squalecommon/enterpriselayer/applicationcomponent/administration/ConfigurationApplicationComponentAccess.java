 ...
 */
public class ConfigurationApplicationComponentAccess extends DefaultExecuteComponent {
    ...
    */
    public SqualixConfigurationDTO getConfiguration() throws JrafEnterpriseException {
    ...
    * @throws JrafEnterpriseException si une erreur survient
    */
    public Collection getSourceManagements() throws JrafEnterpriseException {
    ...
    * @throws JrafEnterpriseException si une erreur survient
    */
    public Collection getProfiles() throws JrafEnterpriseException {
     ...
     */
    public SqualixConfigurationDTO createConfig(InputStream pStream, StringBuffer pErrors) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public SqualixConfigurationDTO importConfig(InputStream pStream, StringBuffer pErrors) throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public Collection getConfigurableTasks(String pManagerName, String pProfileName) throws JrafEnterpriseException {
