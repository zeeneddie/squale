 ...
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public class ErrorTransform implements Serializable {
    ...
    /**
     * Copie complète de la DTO à la BO
     * DTO -> BO pour un Error
    ...
    /**
     * Est utilisé pour remonter une collection d'erreurs aux AC
     * BO -> DTO pour un Error
