...
/**
 * Formule simple
 * Une formule simple s'exprime sous la forme d'une expression
 * qui donne une note sous la forme d'un entier ou d'un flottant.
 * Cette note doit appartenir à l'intervalle 0..3, elle est ajustée
 * si besoin lors de la collecte des résultats
 * @hibernate.subclass 
 * name="SimpleFormula" 
 * discriminator-value="SimpleFormula"
 */
public class SimpleFormulaBO extends AbstractFormulaBO {
    /** Formule de calcul */
