...
public class JavaMailProviderImpl implements IMailerProvider {

	/** logger */
	private static final Log LOG = LogFactory
			.getLog(JavaMailProviderImpl.class);
	...
	static {
		try {
			...
			InputStream is = JavaMailProviderImpl.class.getClassLoader()
	...
	public void sendMail(String sender, String[] recipients, String subject,
