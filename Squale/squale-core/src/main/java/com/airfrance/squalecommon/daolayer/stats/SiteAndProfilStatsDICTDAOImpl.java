...
/**
 */
public class SiteAndProfilStatsDICTDAOImpl extends AbstractDAOImpl {
     ...
     */
    public Collection findBySiteAndProfil(ISession pSession, long pSite, String pProfile) throws JrafDaoException {
     ...
     * @throws JrafDaoException en cas d'échecs
     */
    public void removeWhereSiteAndProfil(ISession pSession, long pSite, String pProfile) throws JrafDaoException {
        String whereClause = "where " + getAlias() + ".serveurBO.serveurId = '" + pSite + "'";
        whereClause += " AND " + getAlias() + ".profil = '" + pProfile + "'";
