 ...
 *
 */
public class MeasureTransform implements Serializable {
     ...
     * @return une instance de la classe associé à pTREKey si elle est présente dans pMeasures, <code>null</code> sinon
     */
     ...
     * @param pResults ResultsDTO ayant en abscisse les clés TRE, si <code>null</code> il est instancié et la première ligne est affectée
     ...
     * @return ResultsDTO à jour
     */
    public static ResultsDTO bo2dtoByAuditOrComponent(ResultsDTO pResults, List pMeasures, List pAbcisse, String pTREKey, Object pObject) {
        ResultsDTO results = null;
