 ...
 *
 */
public class CheckstyleRuleSetDAOImpl extends AbstractDAOImpl {
     ...
     */
    public CheckstyleRuleSetBO createCheckstyleRuleSet(ISession pSession, CheckstyleRuleSetBO pVersionBO) throws JrafDaoException {
    ...
    public CheckstyleRuleSetBO getLastVersion(ISession pSession, String pName) throws JrafDaoException {
     ...
     */
    public void removeCheckstyleRuleSets(ISession pSession, ArrayList pRuleSetsId) throws JrafDaoException {
     ...
     * @throws JrafDaoException si erreur
     */
    public Collection findAllSorted(ISession pSession) throws JrafDaoException {
        StringBuffer whereClause = new StringBuffer();
        whereClause.append("order by ").append(getAlias()).append(".name ASC, ").append(getAlias()).append(".dateOfUpdate DESC");
