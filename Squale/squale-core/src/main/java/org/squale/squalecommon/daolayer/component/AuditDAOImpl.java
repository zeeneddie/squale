    ...
    extends AbstractDAOImpl
{
    ...
    /**
     * Retourne tous les audits supprimées ou appartenant à une appli supprimée et donc l'application n'a pas d'audit en
     * cours
     * 
     * @param pSession la session hibernate
    ...
    /**
     * Permet de récupérer les audits pour la page d'acceuil de squaleWeb. Récupère tous les audits qui ne sont pas
     * supprimés en relation avec pComponentId et qui ont été éxécuté après pDate ou qui sont en attente d'exécution.
     * 
     * @param pSession la session
     ...
     * @param pWithFailedAudits indique si les audits en échec doivent également être collectés pas ce critère en compte
     ...
     * @param pDate la date à partir de laquelle les audits doivent être pris, nulle si on ne prend pas ce critère en
     *            compte
    ...
    /**
     * Décale l'audit de rotation des partitions à la prochaine date prévue Le délai prévu entre 2 rotations est de 12
     * semaines
     * 
     * @param pSession la session
