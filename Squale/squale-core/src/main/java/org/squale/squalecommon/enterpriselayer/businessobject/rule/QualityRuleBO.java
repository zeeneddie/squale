    ...
    implements Serializable, Comparable
{
    ...
    /**
     * Contient le nombre de répartition des notes possibles pour chaque QualityRule 5 pour :<br/>
     * <ul>
    ...
    /**
     * Contient le nombre de répartition des notes possibles pour chaque QualityRule 30 pour tous les intervalles de pas =
     * 0,1 entre 0 et 3 + 2 (un pour les composants ayant 3 pile et un pour les composants non notés)
     */
