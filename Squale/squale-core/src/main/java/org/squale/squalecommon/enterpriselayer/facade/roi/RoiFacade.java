...
public class RoiFacade
{
     ...
     */
    public static RoiDTO updateFormula( RoiDTO pRoiDto, StringBuffer pErrors )
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public static RoiDTO getROI( Long pApplicationId )
        throws JrafEnterpriseException
    {
        // Initialisation
        ISession session = null;
     ...
     * @param pRoi le ROI général contenant l'id de l'application et la formule récupère les résulats des ROI de chaque
     *            Audit sur t-1an sous forme date->valeur et remplit par la même occasion la valeur du ROI global
     * @throws JrafDaoException si erreur
     * @throws FormulaException si formule incorrecte
     */
    private static void getMeasures( ISession pSession, RoiDTO pRoi )
     ...
     */
    public static float calculateROI( int pNbCorrections, SimpleFormulaBO pFormula )
     ...
     */
    public static Map getRoiGraph( RoiDTO pRoi )
        throws JrafEnterpriseException
    {
        // Initialisation
