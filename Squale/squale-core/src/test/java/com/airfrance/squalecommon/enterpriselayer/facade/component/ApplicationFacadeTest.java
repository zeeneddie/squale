...
/**
 * Test de la facade d'application
 *
 * Pour changer le modèle de ce commentaire de type généré, allez à :
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public class ApplicationFacadeTest extends SqualeTestCase {

    
    /**
     * Test de la méthode getApplicationConf(...);
     ...
     * - Test avec nu nom <code>null</code>
     */
    ...
    /**
     * Test de update(ApplicationConfDTO, ISession)
     * - test avec modification des données
     * - test avec ajout d'utilisateurs
     */
