 ...
 */
public class SqualixConfigurationImportTest extends TestCase {
    ...
    /**
     * Teste l'importation de la configuration Squalix à partir du
     * fichier xml.
     * @throws JrafEnterpriseException si erreur
     */
    public void testImport() throws JrafEnterpriseException  {
     ...
     * @throws JrafEnterpriseException si erreur
     */
   public void testProfileDuplicate() throws JrafEnterpriseException  {
        StringBuffer errors = new StringBuffer();
     ...
     * @throws JrafEnterpriseException si erreur
     */
    public void testImportBadFile() throws JrafEnterpriseException  {
        StringBuffer errors = new StringBuffer();
