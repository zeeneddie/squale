 ...
 */
public class SqualeReferenceFacadeTest extends SqualeTestCase {
     ...
     */
    public void testGetProjectResults() throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public void testDeleteAuditListCollection() throws JrafEnterpriseException {
        // Initialisation des parametres de la methode
        Collection projectsToRemove = new ArrayList(SqualeReferenceFacade.getProjectResults(new Integer(2), new Integer(0), false,new Long(0)));
     ...
     */
    public void testValidateAuditListCollection() throws JrafEnterpriseException {
        // Initialisation des parametres de la methode
        Collection projectsToValidate = new ArrayList(SqualeReferenceFacade.getProjectResults(new Integer(2), new Integer(0), false,new Long(0)));
