 ...
 */
public class ValidationApplicationComponentAccessTest extends SqualeTestCase {

    /**
     * teste la validation d'un composant de niveau application
     * @throws JrafEnterpriseException en cas d'échec
     */
    public void testValidationApplicationComponentAccess() throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public void testRemoveApplicationsCreation() throws JrafEnterpriseException {
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public void testValidateApplicationsCreation() throws JrafEnterpriseException {
        // Teste si la methode est accessible par AccessDelegateHelper
        // et si l'objet renvoyé n'est pas nul
        IApplicationComponent appComponent;
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public void testGetApplicationsCreated() throws JrafEnterpriseException {
        // Teste si la methode est accessible par AccessDelegateHelper
        // et si l'objet renvoyé n'est pas nul
        IApplicationComponent appComponent;
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public void testRemoveApplicationsReference() throws JrafEnterpriseException {
        // Teste si la methode est accessible par AccessDelegateHelper
        // et si l'objet renvoyé n'est pas nul
        IApplicationComponent appComponent;
     ...
     * @throws JrafEnterpriseException en cas d'échec
     */
    public void tesGetReference() throws JrafEnterpriseException {
        // Teste si la methode est accessible par AccessDelegateHelper
        // et si l'objet renvoyé n'est pas nul
        IApplicationComponent appComponent;
