 ...
 */
public class RuleCheckingTransgressionItemDAOImplTest extends SqualeTestCase {
     ...
     */
    public void testFindWhereMeasureAndRule() throws JrafDaoException {
        ...
        Collection results = dao.findWhereMeasureAndRule(getSession(), new Long(transgression.getId()), new Long(ruleBO1.getId()));
