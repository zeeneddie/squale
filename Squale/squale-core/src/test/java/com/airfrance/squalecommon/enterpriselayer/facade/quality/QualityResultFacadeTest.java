 ...
 * Fenêtre&gt;Préférences&gt;Java&gt;Génération de code&gt;Code et commentaires
 */
public class QualityResultFacadeTest extends SqualeTestCase {
    ...
    public void testGetRuleChecking() {
        try {
            ...
            float criteriumHomogeneity = (praticeProgramingMark.floatValue() + praticeNamingMark.floatValue() + praticeFormatingMark.floatValue()) / 3f;
