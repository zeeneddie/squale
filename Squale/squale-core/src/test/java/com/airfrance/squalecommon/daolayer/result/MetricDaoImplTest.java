...
/**
 */
public class MetricDaoImplTest extends SqualeTestCase {

    /**
     * 
     * @throws JrafDaoException si erreur
     */
    public void testGetVolumetry() throws JrafDaoException {
        int volumetry = -1;
        ...
        volumetryBySiteAndProfil = metricDAO.getVolumetryBySiteAndProfil(session, appli.getServeurBO().getServeurId(),"java");
        session.commitTransactionWithoutClose();
