...
/** 
 */
public class ProjectParameterDAOImplTest extends SqualeTestCase {
    ...
    public void testRetrieve() {
        try {
            ...
            ProjectBO projectBO = getComponentFactory().createProject(getSession(), appBO, getComponentFactory().createGrid(getSession()));
            ...
            assertEquals(projectBO.getParameters().getParameters().get("liste1"), projectBO2.getParameters().getParameters().get("liste1"));
            assertEquals(projectBO.getParameters().getParameters().get("liste2"), projectBO2.getParameters().getParameters().get("liste2"));
            assertEquals(projectBO.getParameters().getParameters().get("string1"), projectBO2.getParameters().getParameters().get("string1"));
            assertEquals(projectBO.getParameters().getParameters().get("string2"), projectBO2.getParameters().getParameters().get("string2"));
            assertEquals(
                ((ListParameterBO) projectBO.getParameters().getParameters().get("liste1")).getParameters().get(0),
                ((ListParameterBO) projectBO2.getParameters().getParameters().get("liste1")).getParameters().get(0));
            assertEquals(
                ((ListParameterBO) projectBO.getParameters().getParameters().get("liste2")).getParameters().get(0),
                ((ListParameterBO) projectBO2.getParameters().getParameters().get("liste2")).getParameters().get(0));
            assertEquals(
                ((ListParameterBO) projectBO.getParameters().getParameters().get("liste1")).getParameters().get(1),
                ((ListParameterBO) projectBO2.getParameters().getParameters().get("liste1")).getParameters().get(1));
            assertEquals(
                ((ListParameterBO) projectBO.getParameters().getParameters().get("liste2")).getParameters().get(1),
                ((ListParameterBO) projectBO2.getParameters().getParameters().get("liste2")).getParameters().get(1));
            assertEquals(
                ((StringParameterBO) ((ListParameterBO) projectBO.getParameters().getParameters().get("liste1")).getParameters().get(0)).getValue(),
                ((StringParameterBO) ((ListParameterBO) projectBO2.getParameters().getParameters().get("liste1")).getParameters().get(0)).getValue());
            assertEquals(
                ((StringParameterBO) ((ListParameterBO) projectBO.getParameters().getParameters().get("liste1")).getParameters().get(1)).getValue(),
                ((StringParameterBO) ((ListParameterBO) projectBO2.getParameters().getParameters().get("liste1")).getParameters().get(1)).getValue());
            assertEquals(
                ((StringParameterBO) ((ListParameterBO) projectBO.getParameters().getParameters().get("liste2")).getParameters().get(0)).getValue(),
                ((StringParameterBO) ((ListParameterBO) projectBO2.getParameters().getParameters().get("liste2")).getParameters().get(0)).getValue());
            assertEquals(
                ((StringParameterBO) ((ListParameterBO) projectBO.getParameters().getParameters().get("liste2")).getParameters().get(1)).getValue(),
