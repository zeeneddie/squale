...
/**
 */
public class SiteStatsDAOImplTest extends SqualeTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        siteAndProfil =
            new SiteStatsDICTBO(
        mServer.getServeurId(),
                NB_APPLIS,
                NB_APPLIS_EXEC,
                NB_APPLIS_SUCCESSFUL,
                NB_APPLIS_WITHOUT_AUDITS,
                NB_APPLIS_TO_VALIDATE,
                NB_FACTORS_ACCEPTED,
                NB_FACTORS_ACCEPTED_RESERVES,
                NB_FACTORS_REFUSED,
                NB_AUDITS_FAILED,
                NB_AUDITS_SUCCESSFULS,
                NB_AUDITS_PARTIALS,
                NB_AUDITS_NOT_ATTEMPTED,
                ROI);
    }
