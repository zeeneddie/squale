 ...
 */
public class LoginApplicationComponentAccessTest extends SqualeTestCase {
    /** administrateur*/
    ...
    /**
     * Teste avec :
     * - un matricule et mot de passe valide
     * - un matricule valide et mot de passe non valide
     * - un matricule et mot de passe non valide
     */
     ...
     */
    public void testLoginApplicationComponentAccess() throws JrafEnterpriseException {
    ...
    /**
     * Récupération des emails des utilisateurs ayant un certain profil sur une application
     * en fonction de leur email et de leur abonnement
     *
     */
