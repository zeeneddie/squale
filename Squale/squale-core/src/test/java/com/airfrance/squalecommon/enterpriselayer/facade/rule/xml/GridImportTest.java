...
/**
 * Test d'importation au format XML de la grille
 ...
 */
public class GridImportTest extends SqualeTestCase {

    /**
     * Importation d'une grille
     * Ce test vérifie la présence de chacun des attributs présents dans
     * le fichier XML
     */
    public void testImportGrid() {
        ...
        PracticeRuleBO []practices = (PracticeRuleBO[]) criterium.getPractices().keySet().toArray(new PracticeRuleBO[]{});
        int index = 0;
