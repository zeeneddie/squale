    ...
    extends JProject
{
    ...
    /**
     * Contient la liste des projets exportés dont dépend le projet ou la liste des plugins ayant une
     * visibility:=reexport
     */
    ...
    /**
     * @return les entrées du .classpath à traiter après les entrées dont la clé est "lib"
     */
    ...
    /**
     * @param pMap les entrées du .classpath à traiter après les entrées dont la clé est "lib"
     */
