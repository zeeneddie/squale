 ...
 * <li>et pour chaque colonne du fichier csv, le nom de l'attribut de la classe concrète lui correspondant, ainsi que
 * son type objet entièrement spécifié (et pas simple)</li>
 * </ul>
 * 
 * @author m400842
 * @version 1.0
