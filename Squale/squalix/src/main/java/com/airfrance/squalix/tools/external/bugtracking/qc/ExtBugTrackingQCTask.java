 ...
 * 
 */
public class ExtBugTrackingQCTask extends AbstractExtBugTrackingTask {
   ...
   /**
    * Cette méthode lance la récupération des données auprés du logiciel externe.
    * Les données récupérées sont placées dans un objet ExtBugTrackingMetricsBO 
    * @throws TaskException exception levée par la tache
    */
    public void recup() throws TaskException {
