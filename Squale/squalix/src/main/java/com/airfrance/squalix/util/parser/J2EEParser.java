 ...
 */
public class J2EEParser extends JavaParser {
     ...
     * @param pDirectoryPath le nom absolu du répertoire racine à partir duquel le
     * nom du package doit être construit
