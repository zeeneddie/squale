...
public class BuildProjectPath {
    ...
    /** 
     * Construit la liste des projectpath, un projectpath étant la concaténation du viewPath
     * avec le srcPath du projet concerné 
     * Méthode appelée par chaque tache qui a besoin de construire
     * la liste des project path .
