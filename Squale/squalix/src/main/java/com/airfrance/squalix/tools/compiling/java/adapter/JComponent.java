...
/**
 * Cette classe représente un "composant" de compilation JAVA, i.e. 
 * un parseur ou un compilateur. <br />
 * On utilise le pattern <a href="
 * http://labo-sun.com/index.jsp?actionId=32&docId=344&page=8" 
 * target="_new">Adapteur</a>.
 * @author m400832
 * @version 1.0
 */
