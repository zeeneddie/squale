 ...
 * Checkstyle génère ses résultats sous la forme de fichier XML,
 ...
 */
public class CheckstyleReportParser extends XmlImport {
     ...
     * un integer qui donne le nombre de violations
     * @param pReportHandler handler de rapport
     * @throws ConfigurationException si erreur
     */
    public void parse(InputStream pStream, ReportHandler pReportHandler) throws ConfigurationException {
