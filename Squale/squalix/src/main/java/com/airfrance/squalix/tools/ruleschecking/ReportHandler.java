...
/**
 * Traitement d'un rapport checkstyle
 * Cette interface permet de réaliser le traitement des
 * anomalies reportées dans un rapport checkstyle. Toutes
 * les informations disponibles dans le rapport sont passées
 * en paramètre
 */
