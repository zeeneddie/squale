 ...
 */
public class J2eeMackerTask extends MackerTask {
     ...
     */
    private boolean initJsp() throws TaskException {
        boolean can = true;
        ...
        if (null == jsps) {
            ...
            if (classesDir == null) {
                String message = MackerMessages.getString("macker.exception.jsp_class_dir_not_found") + TaskData.JSP_CLASSES_DIR;
