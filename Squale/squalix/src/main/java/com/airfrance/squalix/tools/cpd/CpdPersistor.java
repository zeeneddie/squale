...
/**
 * Persistance des données de Cpd
...
public class CpdPersistor {
     ...
     */
    public void storeResults(ISession pSession) throws JrafDaoException {
        // Création du RuleSet
    ...
    public void addResult(String pLanguage, Iterator pMatches) {
        ...
        while (pMatches.hasNext()) {
            ...
            detail.append(CpdMessages.getString("copypaste.summary", new Object[] { new Integer(m.getLineCount()), new Integer(m.getTokenCount())}));
            detail.append('\n');
            nbOcc++;
            ...
            while (occ.hasNext()) {
                ...
                detail.append(CpdMessages.getString("copypaste.occurrenceentry", new Object[] { new Integer(entry.getBeginLine()), fileName }));
                detail.append('\n');
