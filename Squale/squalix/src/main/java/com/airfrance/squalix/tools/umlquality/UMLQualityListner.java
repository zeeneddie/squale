 ...
 *
 */
public class UMLQualityListner implements QualimetryDataListener,
        QualimetryMessageListener {
   ...
   private UMLQualityTask mUmlqualityTask; 
    ...
    public void connectorError(String pArg0, String pArg1, int pArg2) {
        ...
        LOGGER.error(UMLQualityMessages.getString("logs.error.tools_error") + "  "+ pArg0 +"  "+pArg1+"  "+pArg2);
