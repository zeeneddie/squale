...
/**
 * Manager de lancement de processus externe
 * Une processus permet le lancement d'une commande externe et son
 * suivi en terme de flux de sortie sur stdout et stderr
 * 
 */
public class ProcessManager {
   ...
   public ProcessManager(String[] pCommand, String pEnvp[], File pDir) {
    ...
    public int startProcess(ProcessErrorHandler pHandler) throws IOException, InterruptedException {
        ...
        /* Pour éviter le lock du process, il faut envoyer 
         * le flux d'erreur et le flux de sortie sur des 
         * threads. */
     ...
     * @throws IOException si erreur
     */
    public ProcessOutputStream createOutputStream(InputStream pInput, ProcessOutputHandler pHandler) throws IOException {
        ...
        if(null == mLog) {
            ...
            process = new ProcessOutputStreamInFile(pInput, mOutputHandler, new BufferedWriter(new FileWriter(mLog, true)));
        }
        return process;
    }
