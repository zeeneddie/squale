 ...
 * </ul>
 */
public class JavaMockCompilingTask extends MockCompilingTask {
    /**
     * Logger
     */
    ...
    /**
     * Il faut parcourir tout le classpath afin de mettre les chemins en absolu
     * et vérifier qu'ils existent 
     ...
     */
    private StringBuffer buildClasspath(String pUserClasspath) throws ConfigurationException {
        ...
        StringParameterBO versionParam = (StringParameterBO) mProject.getParameters().getParameters().get(ParametersConstants.DIALECT);
    ...
    /** 
     * {@inheritDoc}
     * Place le paramétre temporaire <code>CLASSES_DIR</code>
     * @see com.airfrance.squalix.tools.compiling.MockCompilingTask#setCompiledDirInTempMap(java.util.List)
     */
    protected void setCompiledDirInTempMap(List pDirs) throws TaskException {
        try {
            // Récupère le classpath
            StringParameterBO classpathParam = (StringParameterBO) mTaskParam.getParameters().get(ParametersConstants.CLASSPATH);
     ...
     */
    private File verifyPath(File pPath) throws ConfigurationException {
        File result = null;
     ...
     */
    private class ExtensionsFileFilter implements FileFilter {
