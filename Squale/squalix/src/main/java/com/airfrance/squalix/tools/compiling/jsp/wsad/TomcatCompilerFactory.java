...
public class TomcatCompilerFactory {
     ...
     */
    public AbstractTomcatCompiler createCompiler(J2eeWSADProject pJ2eeProject, String pServletVersion) throws TomcatCompilerException {
        AbstractTomcatCompiler result;
        if (pServletVersion.equals(ParametersConstants.J2EE1_5) || pServletVersion.equals(ParametersConstants.J2EE1_4)) {
            result = new JWSADJspTomcat2_4Compiler(pJ2eeProject);
        } else if (pServletVersion.equals(ParametersConstants.J2EE1_3) || pServletVersion.equals(ParametersConstants.J2EE1_2)) {
            result = new JWSADJspTomcat2_3Compiler(pJ2eeProject);
        } else {
            throw new TomcatCompilerException(CompilingMessages.getString("exception.unknown.servlet_version", pServletVersion));
        }
        return result;
    }
