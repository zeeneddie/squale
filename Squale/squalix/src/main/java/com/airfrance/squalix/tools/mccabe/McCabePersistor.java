...
/**
 * Objet chargé de faire persister les composants identifiés par McCabe (méthodes et classes) ainsi que les résultats
 * 
 * @author m400842
 * @version 1.0
 */
public class McCabePersistor
{
     ...
     */
    public McCabePersistor( LanguageParser pParser, final McCabeConfiguration pConfiguration, final AuditBO pAudit,
