...
public class McCabeConfiguration
{
    ...
    /**
     * Dossier contenant les fichiers rapports ainsi que le filedb.pc les spécifiant.<br>
     * Les fichiers pré-cités seront copiés dans le workspace McCabe afin d'être utilisés.
     */
    ...
    /**
     * Liste des parseurs utilisés pour chaque extension. L'extension est utilisée comme clé.
     */
    ...
    /**
     * Supprime l'ancien subWorkspace dans le cas où la tâche s'est arrêtée brusquement et que la suppression du
     * répertoire n'a pas pu se faire.
     * 
    ...
    /**
     * Ajoute si le nom du fichier si le message est indiqué dans la partie "addFileNameMessages" du filtre des messages
     * de sortie
     * 
    ...
    /**
     * substitue <code>msg</code> par le message donné en configuration si il est présent dans la liste
     * 
