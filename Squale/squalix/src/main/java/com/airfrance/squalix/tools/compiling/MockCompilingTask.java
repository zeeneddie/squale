...
/**
 * Tâche de compilation dans le cas d'un projet déjà compilé
 * Cette tâche sert juste à mettre à jour les paramètres temporaires
 * liés à la tâche de compilation
 */
public abstract class MockCompilingTask extends AbstractTask {
    /**
     * Logger
     */
    ...
    public void execute() throws TaskException {
        try {
            ...
            ListParameterBO compiledSourcesParam = (ListParameterBO) mTaskParam.getParameters().get(ParametersConstants.COMPILED_SOURCES_DIRS);
     ...
     * racine contenant les fichiers compilés du projet.
     * @param pDirs la liste de StringParameterBO représentant les répertoires
     * ou fichiers compressés contenant les fichiers compilés
     * @throws TaskException si erreur
     */
    protected abstract void setCompiledDirInTempMap(List pDirs) throws TaskException;
