 ...
 */
public class EclipseCompiler implements ProcessErrorHandler, ProcessOutputHandler {
     ...
     */
    public int runCompilation() throws Exception {
        ...
        String[] copyCommand = new String[] { conf.getCopyScript(), conf.getSqualeEclipsePlugins().getAbsolutePath(), conf.getEclipseHome().getAbsolutePath()};
        ...
        String sunLibs = buildSunLibs(((JWSADProject) projectList.get(0)).getBootClasspath(), ((JWSADProject) projectList.get(0)).getJavaVersion());
        ...
        // On crée le process
        ProcessManager compileProcess = new ProcessManager((String[]) command.toArray(new String[command.size()]), null, workspaceDir);
    ...
    private void buildUserLibsOption(MapParameterBO pEclipseLibs) {
         ...
         * @return la liste des librairies sun à ajouter au classpath des projets
         * sous la forme jar1;jar2
         */
            ...
            if (pFile.isDirectory()) {
                ...
                for (int i = 0; i < fileList.length; i++) {
                    ...
                    if (fileList[i].isFile()) {
                        ...
                        if (fileList[i].getAbsolutePath().endsWith(".jar") || fileList[i].getAbsolutePath().endsWith(".zip")) {
        ...
        /**
         * Permet de construire la liste des répertoires de compilation par le log sous la forme
         * output1;output2
