...
/**
 * Permet d'instancier des objets, et de manipuler les appels de méthodes sur 
 * ceux-ci.
 * 
 * 
 * @author m400842
...
public class CSVBeanInstanciator {
    ...
    /**
     * Instancie un objet de la classe identifiée par la paramètre, en utilisant le 
     ...
     */
    public Object instanciate(String pClassName) throws Exception {
    ...
    /**
     * Invoque la méthode de l'objet <code>pBean</code> désignée par 
     * <code>pMethod</code> en passant en paramètre une instance de la classe 
     * <code>pType</code> contenant la valeur <code>pValue.<br>
     ...
     */
    public Object setValue(final Object pBean, final Method pMethod, final String pValue) throws Exception {
    ...
    /**
     * Crée une instance de <code>pObjClass</code> avec la valeur initiale 
     * <code>pValue</code>.<br>
     * La classe <code>pType</code> doit posséder un constructeur prenant en paramètre 
     * une <code>String</code>.
