 ...
 */
public class SourceCodeAnalyserTask extends AbstractTask {
    /**
     * Logger
     */
    ...
    /**
     * Modifie le paramètre <code>view_path</code> des paramètres temporaires.
     * Extrait si besoin le fichier compressé
     * @param pFile le fichier vers l'arborescence du projets
     * @throws Exception si erreur
     */
    private void modifyViewPathInTempMap(File pFile) throws Exception {
