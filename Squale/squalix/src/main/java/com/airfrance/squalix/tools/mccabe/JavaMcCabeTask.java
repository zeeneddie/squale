...
/**
 * Exécute l'analyse McCabe sur un projet java. L'environnement McCabe doit être correctement
 ...
 * 
 */
public class JavaMcCabeTask extends AbstractMcCabeTask implements CSVParser.CSVHandler {
    ...
    /**
     * {@inheritDoc}
     * On doit utiliser un parser java
