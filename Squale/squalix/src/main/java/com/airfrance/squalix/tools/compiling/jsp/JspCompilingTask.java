 ...
 * classpath correctement formé et accessible via le paramètre temporaire <code>CLASSPATH</code>
 */
    ...
    implements BuildListener
{
    ...
    /**
     * 1. Vérifie que les sources vers les JSPs existent et sont bien des répertoires racines de pages JSPs (ie. a des
     * .jsp à la racine ou à la racine de ses répertoires) 2. Construit la liste des jsps à compiler sous forme de map.
     * La map est de la taille de la liste donnée dans les paramétres du projet et chaque entrée correspond contient la
     * liste des fichiers JSPs que le répertoire de même index contient. Ex : ParametersConstants.JSP = {path1, path2}
     * alors le résultat sera {{*.jsp dans path1}, {*.jsp dans path2}} PRE-CONDITION : le paramétre du projet
     ...
     * @return true si le répertoire contient des .jsp à la racine ou à la racine de ses répertoires.
     */
    ...
    /**
     * Modifie les paramètres du projet wsad PRECONDITION : Les paramétres du projet ont été vérifiés et ne sont pas
     * nuls.
     * 
