...
public class MackerConfiguration {
    ...
    /**
     * Modifie la liste des fichiers à analyser dans un répertoire donné
     * et en appliquant un filtre précis.
    ...
    /**
     * Retourne la liste des fichiers à analyser dans un répertoire donné
     * en appliquant un filtre précis.
     * @param classesDir le répertoire des fichiers à récupérer
