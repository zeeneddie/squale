 ...
 * de fichiers de classpath pour les projets RSA7
 */
public class JRSAParserConfiguration extends JWSADParserConfiguration {
    /**
    ...
    /**
     * Chemin vers le fichier contenant les propriétés d'un
     * projet J2EE (sert à récupérer le répertoire d'application qui est par défaut WebContent)
     */
     ...
     */
    public JRSAParserConfiguration() throws Exception {
        super();
    }
    ...
    protected void createReflectionMap() throws Exception {
        ...
        mMap.put(CompilingMessages.getString("configuration.java.parsing.wsad.values.value.name.con"), this.getClass().getDeclaredMethod("setCon", new Class[] { String.class }));
    }
