...
/**
 * Parseur de résultat cppTest
 * CppTest génère ses résultats sous la forme de fichier XML,
 * cette classe permet de lire le contenu d'un tel fichier.
 * Le fichier de rapport est organisé en deux sections : la première
 * donne la liste des règles, la seconde la liste des violations rencontrées
 */
public class ReportParser extends XmlImport {
    /** Préfixe de fichier */
     ...
     * @return collection de résultats sous la forme
     * d'une map avec en clef le nom de la règle et en valeur
     * une collection qui donne le détail de chaque violation sous la forme d'une String
     * @throws ConfigurationException si erreur
     */
    public Map parse(InputStream pStream, String pFilePrefix) throws ConfigurationException {
        Map result = null;
        ...
        digester.addCallMethod("Log/Group/Test/Message/Property", "setMessage", 2, new Class[] { String.class, String.class });
    ...
    class ResultWrapper {
        ...
        /**
         * Modification des attributs en fonction de <code>pName</code> et formatage de
         * la valeur si besoin
         * @param pName nom 
         * @param pValue valeur
         */
        ...
        public void addMessage(String pStatus) {
            ...
            if (pStatus.equals("failure")) {
                ...
                list.add(CppTestMessages.getString("transgression.detail", new Object[] { mFile, mLine, mDescription }));
            }
        }
        ...
        public void addItem(String pStatus) {
            ...
            if (pStatus.equals("failure")) {
                ...
                item.setMessage(CppTestMessages.getString("transgression.detail", new Object[] { RuleCheckingTransgressionItemBO.PATH_KEY, RuleCheckingTransgressionItemBO.LINE_KEY, mDescription }));
                list.add(item);
            }
        }
    }
