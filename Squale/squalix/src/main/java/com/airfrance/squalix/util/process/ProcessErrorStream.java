...
/**
 * Traitement du flux stderr des processus
 * Le flux stderr est traité dans un thread pour éviter les deadlocks
 */
class ProcessErrorStream implements Runnable {

    /**
     * Logger.
     */
    private static final Log LOGGER = LogFactory.getLog(
    ProcessErrorStream.class);;
