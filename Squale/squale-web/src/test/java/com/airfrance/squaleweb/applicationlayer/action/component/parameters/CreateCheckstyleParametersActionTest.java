 ...
 */
public class CreateCheckstyleParametersActionTest extends SqualeWebTestCase {
    ...
    /**
     * Test de remplissage du formulaire de configuration Checkstyle
     * On charge plusieurs rulesets checkstyle de même nom et on positionne les paramètres
     * du projet sur le nom du ruleset
     * Le formulaire en sortie doit contenir un seul ruleset
     */
    ...
    /**
     * Test d'ajout de la configuration checkstyle
     * On positionne les paramètres avec les sources et le ruleset chekstyle
    ...
    public void testAddProjectCheckstyle() {
        try {
            ...
            StringParameterDTO param = (StringParameterDTO) params.getParameters().get(ParametersConstants.CHECKSTYLE_RULESET_NAME);
