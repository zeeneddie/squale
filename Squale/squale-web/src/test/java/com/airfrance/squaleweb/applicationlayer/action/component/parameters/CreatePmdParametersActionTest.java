 ...
 */
public class CreatePmdParametersActionTest extends SqualeWebTestCase {
     ...
     */
    protected PmdRuleSetDTO createRuleSet(String pResourceName) throws JrafEnterpriseException {
    ...
    /**
     * Test de remplissage du formulaire de configuration Pmd en configuration java
     * On charge plusieurs rulesets pmd de même nom et on positionne les paramètres
     * du projet sur le nom du ruleset
     * Le formulaire en sortie doit contenir un seul ruleset et ne doit pas contenir
     * de données jsp
     */
    ...
    /**
     * Test de remplissage du formulaire de configuration Pmd en configuration java et jsp
     * On charge plusieurs rulesets pmd de même nom et on positionne les paramètres
     * du projet sur le nom du ruleset
     * Le formulaire en sortie doit contenir un seul ruleset java et un seul ruleset jsp
     */
    ...
    /**
     * Test d'ajout de la configuration Pmd dans un contexte java
     * On positionne les paramètres avec les sources et le ruleset pmd/java
    ...
    public void testAddProjectPmdJava() {
        try {
            ...
            StringParameterDTO javaParam = (StringParameterDTO) pmdParams.getParameters().get(ParametersConstants.PMD_JAVA_RULESET_NAME);
            assertNotNull("ruleset renseigné", javaParam);
            assertEquals("ruleset", javaRuleSetName, javaParam.getValue());
            StringParameterDTO jspParam = (StringParameterDTO) pmdParams.getParameters().get(ParametersConstants.PMD_JSP_RULESET_NAME);
    ...
    /**
     * Test d'ajout de la configuration Pmd dans un contexte java/jsp
     * On positionne les paramètres avec les sources et le ruleset pmd/jsp et java
     * En sortie on doit obtenir les paramètres du projet en conséquence
     */
