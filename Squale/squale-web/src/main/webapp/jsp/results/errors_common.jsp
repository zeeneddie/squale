...
if (null == expanded) {
    expanded = "false";
			...
			<table >
				...
				<tr>
					...
					<td><af:dropDownPanel titleKey="<%=taskName%>"
						...
						<af:table name="setOfErrorsListForm" property='<%="listOfErrors[" + index + "].list"%>'
		...
		<af:dropDownPanel titleKey="image.legend">
			<table>
				<tr>
					<td><img src="/squale/images/pictos/error.png" alt="error_image" /><bean:message
						key="error.criticity.fatal" /></td>
					<td><img src="/squale/images/pictos/warning.png"
						alt="warning_image" /><bean:message key="error.criticity.warning" /></td>
					<td><img src="/squale/images/pictos/info.png" alt="info_image" /><bean:message
