...
/**
 */
public abstract class AbstractRepartitionMaker
    extends AbstractGraphMaker
{
    ...
    /**
     * Applique la couleur a la série en cours Méthode abstraite car la méthode concrète dépend du type du renderer
     * 
