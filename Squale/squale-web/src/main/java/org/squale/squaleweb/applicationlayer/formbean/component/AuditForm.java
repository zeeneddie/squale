    ...
    implements WIEditable
{
    ...
    public void wValidate( ActionMapping mapping, HttpServletRequest request )
    {
        ...
        if ( getType().equals( AuditBO.MILESTONE ) )
        {
            ...
            {
                addError( "historicalDate", new ActionError( "error.date.uncorrectFormat",
                                                             WebMessages.getString( request, "date.format.simple" ) ) );
            }
            else
            {
        ...
        else
        {
            ...
            if ( getDate() == null )
            {
                addError( "date", new ActionError( "error.date.uncorrectFormat",
                                                   WebMessages.getString( request, "date.format.simple" ) ) );
            }
        }
    }
     ...
     * 
     * @param pRestartDelay le délai de reprogrammation paramétrée de l'application associée à l'audit
     */
