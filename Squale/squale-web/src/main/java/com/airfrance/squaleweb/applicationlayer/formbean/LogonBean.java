 ...
 */
public class LogonBean extends WResultAction implements WILogonBeanSecurity {
    /**
    ...
    /**
     * La liste des applications accessibles à l'utilisateur.
     * La clé est l' id de l'application (Long), la valeur le nom du profil associé (String).
     */
    ...
    /** 
     * @see com.airfrance.welcom.struts.bean.WIResultAction#setResultAction(java.lang.String)
     * {@inheritDoc}
     */
    ...
    /** 
     * @see com.airfrance.welcom.struts.bean.WIResultAction#getResultAction()
     * {@inheritDoc}
     */
     ...
     * Les droits liés à l'application sont prioritaires par
     * rapport aux droits par défaut.<br>
    ...
    /**
     * Construit les groupes d'applications pour le menu header
     * PRECONDITION : les applications sont triées par ordre alphabétique
     * @param applications les applications
     * @param key la clé de configuration présentant 
     * (ex : E,R qui signifie grouper les applications dont la première lettre < E puis entre F et R
     * et enfin celles après R)
     * @param minApplis le nombre minimum d'applications dans le menu pour que le regroupement soit effectué
     * @return les applications groupées alphabétiquement :
     * ex :
     *      key : A - E (le message du menu)
     *      value : Appli1, Appli2,... (les applications dont la première lettre du nom est entre A et E)
     */
    ...
    /**
     * Cette méthode permet de ne pas se retrouver avec un groupe vide lors de la construction
