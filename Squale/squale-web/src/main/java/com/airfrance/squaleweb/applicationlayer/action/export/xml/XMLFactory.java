...
public class XMLFactory {
     ...
     */
    public static void generateXMLtoHTTPResponse(final XMLData xmldata, final HttpServletResponse response, final String attachementFileName) throws XMLGeneratorException {
        try {
     ...
     */
    private static void generateXML(XMLData xmldata, PrintWriter printer) throws TransformerException {
        xmldata.fill();
