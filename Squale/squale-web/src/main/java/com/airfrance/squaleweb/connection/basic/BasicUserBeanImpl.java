 ...
 *The userBean is the bean for authentication.
 *In this case, the userBean contains the identifier and the profiles of the authenticated user.
 *When there is no user authenticate, identifier and profiles are null.   
 *In the basic implementation the authentication verification is done 
 *directly in the squale database (in the userBO table) 
 */
public class BasicUserBeanImpl implements IUserBean {
	 ...
	 * An authenticated user is a squale administrator if its list of profiles contains
	 * the profile : bo.profile.name.admin
