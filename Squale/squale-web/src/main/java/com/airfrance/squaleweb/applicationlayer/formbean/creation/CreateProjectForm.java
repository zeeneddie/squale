 ...
 * @author
 */
public class CreateProjectForm extends ActionIdFormSelectable {
    ...
    /**
     * Liste des tâches configurables et dont la configuration
     * est avancée
     */
    private List mAdvancedTasks;

    /**
     * Liste des noms des beans associés aux paramètres
     * du projet.
     */
    ...
    /**
     * Méthode de validation pour vérifier que le nom mis à l'application ne contient pas de caractèrs spéciaux.
