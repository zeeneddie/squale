 ...
 *
 */
public class ReferenceTransformer implements WITransformer {
    /**
     * Transforme une liste de résultats de facteurs (les listes doivent directement
     * contenir les valeurs) en un form.
     * 
    ...
    public void objToForm(Object[] pObject, WActionForm pForm) throws WTransformerException {
        ...
        if (pObject[0] instanceof SqualeReferenceDTO) {
            ...
            objToForm((AuditGridDTO) pObject[++index], (Collection) pObject[++index], (Collection) pObject[++index], (Map) pObject[++index], form);
        }
    }
     ...
     * @throws WTransformerException si un pb apparait.
     */
    private void objToForm(SqualeReferenceDTO pReference, ReferenceForm pForm) throws WTransformerException {
     ...
     * @throws WTransformerException si un pb apparait.
     */
    private void objToForm(AuditGridDTO pAuditGrid, Collection pValues, Collection pApplications, Map pApplicationMeasures, ReferenceForm pForm) throws WTransformerException {

        Iterator values = pValues.iterator();
        pForm.setId(pAuditGrid.getProject().getID());
        pForm.setApplicationName(TransformerUtils.getApplicationName(pAuditGrid.getProject().getIDParent(), pApplications));
     ...
     */
    private WActionForm objToForm(FactorRuleDTO pFactorDTO, Float pValue) throws WTransformerException {
        Object[] params;
