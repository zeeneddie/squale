...
public abstract class SqualeWebConstants {
    /**
     * Liste des profils sur les applications
     * <br>
     ...
     * contenant la liste des résultats courants à afficher.
     */
    public final static String RESULTS_KEY = "results";

    /**
     * Contient la clé de référence de l'attribut de session
     * contenant la liste des tops d'un projet 
     */
    public final static String TOP_KEY = "top";

    /**
     * Contient la clé de référence de l'attribut de session
     * contenant la liste des notes des pratiques courantes à afficher.
     */
    public final static String PRACTICES_KEY = "practices";

    /**
     * Contient la clé de référence de l'attribut de session
     * contenant la liste des notes des pratiques courantes à afficher dans la vue météo
     */
    public final static String PRACTICES_LIST_KEY = "practices.meteo";

    /**
     * Contient la clé de référence de l'attribut de session
     * contenant la liste des composants enfants à afficher.
     */
    public final static String CHILDREN_KEY = "children";

    /**
     * Contient la clé de référence de l'attribut de session
     * contenant la liste des détails d'une transgression à afficher.
     */
    ...
    /**
     * Clé indiquant si on vient directement d'une vue composant ou non,
     * sert pour le traceur
     */
    ...
    /**
     * Contient la clé de référence de l'attribut de session
     * spécifiant si une page à été validée (review.jsp)
     */
    ...
    /**
     * Contient la clé indiquant si on a crée un nouveau projet
     * permet de savoir quand on doit envoyer un mail
     */
