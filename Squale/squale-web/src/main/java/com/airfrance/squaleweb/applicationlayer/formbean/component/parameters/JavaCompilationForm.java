...
/**
 * Contient les paramètres de compilation Java pour une tâche ANT ou un
 * workspace WSAD.
 */
public class JavaCompilationForm extends RootForm {
    ...
    public void wValidate(ActionMapping mapping, HttpServletRequest request) {
        ...
        } else if(ParametersConstants.ANT.equals(getKindOfTask())) { // Il s'agit d'une règle ant
