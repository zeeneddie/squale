 ...
 */
public class PracticeResultTransformer implements WITransformer {
    ...
    public void objToForm(Object[] object, WActionForm form) throws WTransformerException {
        ...
        if (null != value) {
            ...
            practiceResult.setFloatRepartition((Integer[]) resultDTO.getFloatRepartitionPracticeMap().get(audits.get(0)));
