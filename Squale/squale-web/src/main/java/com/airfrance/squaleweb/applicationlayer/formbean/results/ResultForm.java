 ...
 *
 */
public class ResultForm extends RootForm {
    ...
    /**
     * On indique le type de la formule car l'affichage des labels est différent selon 
     * le type de formule
     */
    ...
    /**
     * La répartition, utilisée uniquement dans le cas d'une pratique
     * Ce sont des valeurs entières, mais on définit un tableau de double
     * pour le graphique (qui prend obligatoirement en paramètre un tableau de double)
     */
