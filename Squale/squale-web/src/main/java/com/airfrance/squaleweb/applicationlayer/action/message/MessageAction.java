 ...
 */
public class MessageAction extends AdminAction {
    /**
     ...
     */
    public ActionForward importMessages(ActionMapping pMapping, ActionForm pForm, HttpServletRequest pRequest, HttpServletResponse pResponse) {
        ...
        try {
            ...
            MessageProvider messages = MessagesDTOTransformer.transform(ac.execute("importMessages", new Object[] { form.getInputStream(), importErrors }));
     ...
     * @return l'action à réaliser.
     */
    public ActionForward reloadMessages(ActionMapping pMapping, ActionForm pForm, HttpServletRequest pRequest, HttpServletResponse pResponse) {
