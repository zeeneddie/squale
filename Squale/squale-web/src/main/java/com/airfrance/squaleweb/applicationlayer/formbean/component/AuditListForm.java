 ...
 *
 */
public class AuditListForm extends RootForm {
    ...
    /**
     * permet d'obtenir la date de l'audit courant sur lequel on travaille
    ...
    public String getDate(HttpServletRequest pRequest) {
        ...
        if (pRequest.getSession().getAttribute(BaseDispatchAction.CURRENT_AUDIT_DTO) != null) {
            auditDate = ((AuditDTO) pRequest.getSession().getAttribute(BaseDispatchAction.CURRENT_AUDIT_DTO)).getFormattedDate();
        }
        return auditDate;
    }

    /** 
     * la liste des audits terminés
     * Sert notamment pour les stats admins 
     */
    ...
    /** 
     * la liste des audits interrompus ou en cours
     * Sert notamment pour les stats admins 
     */
    ...
    /** 
     * la liste des audits partiels ou en échec
     * Sert pour les admins 
     */
