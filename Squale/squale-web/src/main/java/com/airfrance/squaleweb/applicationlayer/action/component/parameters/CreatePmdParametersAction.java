...
/**
 * Action de paramétrage des paramètres de la tâche Java/Jsp PMD
 * Une même action permet le paramétrage de la tâche PMD dans un contexte java seul
 * ou avec le contexte jsp
 */
public class CreatePmdParametersAction extends CreateParametersAction {
