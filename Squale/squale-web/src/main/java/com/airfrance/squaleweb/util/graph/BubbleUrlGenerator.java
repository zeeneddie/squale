...
/**
 * @author 6370258
 * Classe de génération de liens spécifiques à chaque point du graphe de type Bubble
 */
public class BubbleUrlGenerator extends AbstractURLGenerator implements XYURLGenerator {
    ...
    public String generateURL(XYDataset pDataset, int pSeries, int pItem) {
        String url = "project_component.do?action=component&projectId=" + mProjectId 
        + "&currentAuditId=" + mCurrentAuditId  + "&component=" + tbComponentId[pItem];
