 ...
 */
public class AnalyserTransformer implements WITransformer {
    ...
    public void objToForm(Object[] pObject, WActionForm pForm) throws WTransformerException {
        ...
        if (taskParam != null) {
            StringParameterDTO pathParam = (StringParameterDTO) taskParam.getParameters().get(ParametersConstants.PATH);
            if (pathParam != null) {
