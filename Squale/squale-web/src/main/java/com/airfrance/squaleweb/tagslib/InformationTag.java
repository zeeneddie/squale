...
/**
 * pour tout ce qui concerne les infos sur les différent(e)s
...
public class InformationTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        // Publie
        ResponseUtils.write(pageContext, makeResult((String) RequestUtils.lookup(pageContext, name, practiceName, null),
    ...
    /**
     * @return le code pour l'image permettant d'afficher les informations
     * sur le facteur/critère/pratique
    ...
    private String makeResult(String practiceKey,String ruleIdValue, HttpServletRequest pRequest) {
        ...
        String pictureHelp = (WebMessages.getString(pRequest, "project.results.factors.information") + ": " + realName).replaceAll("\"","") ;
