 ...
 */
public class ExcelDataApplicationsStatsList extends ExcelData {
     ...
     */
    public ExcelDataApplicationsStatsList(final Locale pLocale, final MessageResources pMessages, List pApplicationsStatsForm, String pMatricule) {
