 ...
 * @author M400842
 */
public class ComponentMetricsComparator implements Comparator {
    ...
    /**
     * Constructeur.<br />
     * Si l'index de la métrique est égal à -1,
     * alors les composants sont comparés par rapport à leurs noms.
     * 
    ...
    private int compare(final ComponentForm pForm1, final ComponentForm pForm2) {
        ...
        //System.err.println("Comparaison de : " + value1.floatValue() + " et " + value2.floatValue() + " donne : " + (int)(value1.floatValue() - value2.floatValue()));
