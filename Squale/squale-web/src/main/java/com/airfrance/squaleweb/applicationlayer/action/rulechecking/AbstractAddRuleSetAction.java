 ...
 */
public abstract class AbstractAddRuleSetAction extends AdminAction {
    /**
     ...
     */
    public ActionForward importConfiguration(ActionMapping pMapping, ActionForm pForm, HttpServletRequest pRequest, HttpServletResponse pResponse) {
