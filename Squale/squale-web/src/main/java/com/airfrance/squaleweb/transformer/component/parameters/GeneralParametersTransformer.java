 ...
 */
public class GeneralParametersTransformer implements WITransformer {
    ...
    public void objToForm(Object[] pObject, WActionForm pForm) throws WTransformerException {
        ...
        // excludedPatterns
        ListParameterDTO excludedList = (ListParameterDTO) params.getParameters().get(ParametersConstants.EXCLUDED_PATTERNS);
        if (excludedList != null) {
            generalForm.setExcludePatterns(getPatternsTab(excludedList));
        }
        // includedPatterns
        ListParameterDTO includedList = (ListParameterDTO) params.getParameters().get(ParametersConstants.INCLUDED_PATTERNS);
