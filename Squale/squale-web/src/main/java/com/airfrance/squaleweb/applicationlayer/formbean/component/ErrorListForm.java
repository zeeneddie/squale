 ...
 *
 */
public class ErrorListForm extends RootForm {
    ...
    /**  
     * le niveau maximal d'erreur pour cette tache
     * Sert notamment pour mettre l'icone de niveau de criticité sur la page Web
     */
