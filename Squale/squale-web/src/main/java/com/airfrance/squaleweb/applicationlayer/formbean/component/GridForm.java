 ...
 * 
 */
public class GridForm extends ActionIdFormSelectable {
    /**
     * Nom de la grille
     */
    ...
    /** 
     * le text que peut remplir l'administrateur pour indiquer aux gestionnaires
     * d'applications utilisant cette grille les différentes modifications
     */
