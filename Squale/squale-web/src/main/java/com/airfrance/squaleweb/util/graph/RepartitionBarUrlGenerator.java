...
public class RepartitionBarUrlGenerator extends AbstractRepartitionUrlGenerator implements CategoryURLGenerator {
     ...
     */
    public RepartitionBarUrlGenerator(String pProjectId, String pCurrentAuditId,String pPreviousAuditId, String pPracticeId, String pFactorParentId, int pNbSeries) {
