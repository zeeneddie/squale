...
public class ComponentComparator implements Comparator {
    ...
    public int compare(Object pComp1, Object pComp2) {
        ...
        if (pComp1 instanceof ComponentDTO) {
            ...
            result = ((ApplicationForm) pComp1).getApplicationName().compareToIgnoreCase(((ApplicationForm) pComp2).getApplicationName());
        } else if (pComp1 instanceof ProjectForm) {
            result = ((ProjectForm) pComp1).getProjectName().compareToIgnoreCase(((ProjectForm) pComp2).getProjectName());
