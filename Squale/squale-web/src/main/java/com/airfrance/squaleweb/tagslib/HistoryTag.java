...
public class HistoryTag extends TagSupport {
    ...
    /** indique si la valeur à mettre dans le which= de la requete
     * est un nombre ou une regle
     */
    private String kind;
    ...
    private String getHistory(HttpServletRequest pRequest) {
        ...
        // L'action appelante
        String oldAction = pRequest.getContextPath() + ((ActionMapping) pRequest.getAttribute(Globals.MAPPING_KEY)).getPath() + ".do?";
        ...
        // Création du lien
        String link = "/squale/review.do?action=review&projectId=" + projectId + complementaryRequest + "&which=" + ruleId + "\"";
