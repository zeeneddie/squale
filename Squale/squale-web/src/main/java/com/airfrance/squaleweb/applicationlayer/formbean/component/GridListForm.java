 ...
 */
public class GridListForm extends RootForm{
    /**
     * Liste des grilles
     */
    private List mGrids = new ArrayList();
    /**
     * Liste des noms des grilles qui ne sont liées à aucun profil
     * et à aucun audit
     */
    ...
    /**
     * @return la liste des noms des grilles qui ne sont liées à aucun profil
     * et à aucun audit
     */
    ...
    /**
     * @param pUnlikedGrids la liste des noms des grilles qui ne sont liées à aucun profil
     * et à aucun audit
     */
