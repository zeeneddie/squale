 ...
 */
public class ApplicationStatsTransformer implements WITransformer {
    ...
    public void objToForm(Object[] pObject, WActionForm pForm) throws WTransformerException {
        ...
        form.setValidatedApplicationStr(WebMessages.getString(locale, "stats.application.validated."+dto.isValidatedApplication()));
        form.setPurgeFrequency(dto.getPurgeFrequency());
    }
    
    /**
     * Retourne la date formatée sous la forme définie dans le fichier de properties
     * par la clé définie dans la constante <code>FORMAT_DATE_KEY</code>
