...
public class Tracker {
     ...
     * @param pReset indique si on est repassé par un menu auquel cas 
     * on redémarre une série historique
     */
    ...
    private void newTrackerAccessWay(TrackerStructure pTs,int pIndex) {
        ...
        if (pTs.getType() != TrackerStructure.UNDEFINED && pTs.getType() == ((TrackerStructure) mTracker.get(pIndex)).getType()) {
