...
public abstract class AbstractGraphMaker {
     ...
     */
    protected boolean mShowLegend = WebMessages.getBool("default.abstract.show_legend"); //true; // Valeur par défaut
    /**
     * Hauteur de l'image
     */
    ...
    /**
     * Permet de fabriquer l'image sous forme d'un tableau de byte
     * <b>Attention : </b> la méthode de la classe fille doit vérifier que mChart est initialisé 
    ...
    /**
     * Cette méthode retourne le diagramme. 
     * Dans les classes concrétes, cette méthode est responsable de la construction du diagramme 
     * s'il n'est pas encore construit. 
