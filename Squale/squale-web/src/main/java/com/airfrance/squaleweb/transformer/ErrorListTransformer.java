 ...
 *
 */
public class ErrorListTransformer extends AbstractListTransformer {
    /**
    ...
    public void objToForm(Object[] pObject, WActionForm pForm) throws WTransformerException {
        ...
        if (null != dto) {
            ...
            while (it.hasNext()) {
               ErrorForm error = (ErrorForm)WTransformerFactory.objToForm(ErrorTransformer.class, (ErrorDTO) it.next());
