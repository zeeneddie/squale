 ...
 * @author M400842
 */
public class ProjectForm extends ActionIdFormSelectable {
    ...
    /** 
     * un booléen juste pour indiquer si le projet a un audit terminé,
     * n'est pas stocké en base sert juste pour l'affichage
     */
