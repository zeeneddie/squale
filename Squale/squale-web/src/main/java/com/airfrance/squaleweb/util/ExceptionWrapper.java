 ...
 * Cette classe permet de remonter des exceptions au niveau de l'utilisateur via une JSP
 * Une clef de configuration permet d'activer la génération du StackTrace au niveau de la
 * réponse renvoyée par la JSP.
 */
public class ExceptionWrapper {
     ...
     * @param pw writer
     */
    private static void fillExceptionTrace(
        ...
        if (pException instanceof ServletException) {
            ...
            if ((pException.getCause() != null)
                && (pException.getCause() != pException)) {
