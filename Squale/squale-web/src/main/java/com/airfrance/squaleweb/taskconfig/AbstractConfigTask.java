...
public abstract class AbstractConfigTask {
    ...
    /** 
     * Titre de la rubrique contenant les infos de
    ...
    /** 
     * Collection des infos de configuration nécessaire pour effectuer la tache
     * Cette collection contient des objets InfoConfig
     */
    ...
    /**
     * Tache abstraite qui servira à initialiser la liste des champs 
     * nécessaire dans la JSP pour pouvoir configurer la tache
     */
