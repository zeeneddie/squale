...
/**
 */
public class ProjectErrorTransformer extends ProjectTransformer implements WITransformer {
    ...
    public void objToForm(Object[] pObject, WActionForm pForm) throws WTransformerException {
        ...
        if(null != pObject[1]) {
            ...
            form.getErrorsRepartition()[ProjectForm.ERROR_ID] = (((Integer[]) pObject[1])[ProjectForm.ERROR_ID].intValue());
            form.getErrorsRepartition()[ProjectForm.WARNING_ID] = (((Integer[]) pObject[1])[ProjectForm.WARNING_ID].intValue());
            form.getErrorsRepartition()[ProjectForm.INFO_ID] = (((Integer[]) pObject[1])[ProjectForm.INFO_ID].intValue());
        }
