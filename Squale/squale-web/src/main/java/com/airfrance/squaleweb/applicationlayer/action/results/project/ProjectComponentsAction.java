    ...
    extends ReaderAction
{
    ...
    /**
     * Nom de l'attibut en session pour indiquer à l'utilisateur que tous ces composants ne sont pas affichés.
     */
                               ...
                               HttpServletResponse pResponse )
    {
        ...
        try
        {
            ...
            {
                paramIn =
                    new Object[] { projectDTO, ComponentType.PACKAGE, auditDTO, ( (ComponentForm) pForm ).getFilter() };
