 ...
 */
public class RuleCheckingItemsListTransformer implements WITransformer {
    ...
    public void objToForm(Object[] pObject, WActionForm pForm) throws WTransformerException {
        ...
        for(Iterator it = details.iterator(); it.hasNext();) {
            ...
            RuleCheckingItemForm itemForm 
                = (RuleCheckingItemForm)transformer.objToForm(new Object[] {itemDTO});
