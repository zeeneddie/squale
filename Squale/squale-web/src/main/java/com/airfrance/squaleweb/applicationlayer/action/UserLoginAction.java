...
/**
 * Action class for the login. This action is call by the login.jsp 
 * when a user send his login and password for authentication.
 */
public class UserLoginAction extends DefaultAction{

	/**
	 * This method try to do the connection of the user
	 * if the authentication succeed then the action login.do is call
	 ...
	 */
	public ActionForward execute(ActionMapping pMapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
