...
public class ManageApplicationUtils {
     ...
     */
    public static ApplicationConfDTO getApplication(String pApplicationId) throws JrafEnterpriseException {
     ...
     */
    public static CreateApplicationForm getCreateApplicationForm(String pApplicationId, HttpServletRequest pRequest) throws JrafEnterpriseException, WTransformerException {
        // Recharge le form
        ...
        CreateApplicationForm form = (CreateApplicationForm) WTransformerFactory.objToForm(ApplicationConfTransformer.class, paramIn2);
     ...
     */
    public static AuditDTO getLastNotAttemptedAudit(long pApplicationID) throws JrafEnterpriseException {
