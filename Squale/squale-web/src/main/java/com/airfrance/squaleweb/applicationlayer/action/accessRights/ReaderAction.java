    ...
    extends BaseDispatchAction
{
    ...
    protected boolean checkRights( LogonBean pUser, Long pApplicationId )
    {
        return pUser.isAdmin()
            || ( pApplicationId != null && pUser.getApplicationRight( pApplicationId ) != null // illegal access
            && ( pUser.getApplicationRight( pApplicationId ).equals( ProfileBO.MANAGER_PROFILE_NAME ) || pUser.getApplicationRight(
                                                                                                                                    pApplicationId ).equals(
                                                                                                                                                             ProfileBO.READER_PROFILE_NAME ) ) );
    }
