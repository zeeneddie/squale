...
<%--
Permet le parsing d'un nouveau fichier de configuration CppTest
 --%>
...
<af:page>
	<af:body canvasLeftPageInclude="/jsp/canvas/cpptest_menu.jsp">
		<af:canvasCenter titleKey="rulechecking.cpptest.import.title"
			subTitleKey="rulechecking.cpptest.import.subtitle">
			<br />
			<af:form action="parseCppTestRuleset.do" method="POST"
