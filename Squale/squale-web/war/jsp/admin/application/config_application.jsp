	...
	<af:body onload="setEnabledCost(),enabledFrequencyAudit()">
		<af:canvasCenter titleKey="<%=title%>">
			...
			<af:form action="manageApplication.do">
				<%-- Attribute DO_NOT_RESET_FORM so as to update the name of the application in the main tables DB --%>
				<input type="hidden"
					name="<%=org.squale.squaleweb.applicationlayer.action.accessRights.BaseDispatchAction.DO_NOT_RESET_FORM%>"
					value="true">
				<%-- Attribute DO_NOT_UPDATE_PROJECT_NAME so as to update the name of the application in the squaleReference table --%>
				<input type="hidden"
				...
				<!-- table width="100%" class="formulaire" cellpadding="0"
					...
					<tr-->
				<h2><%--af:field key="application.creation.field.application_name"
							property="applicationName" styleClassLabel="td1Ext"
							access="READONLY" /--%> <bean:message
					key="application.creation.field.application_name" /> <bean:write
					name="createApplicationForm" property="applicationName" /></h2>
				<!-- /tr>
				</table-->
				<br />
				<!-- Renaming application interface-->
				<table width="100%" class="formulaire" cellpadding="0"
					cellspacing="0" border="0">
					<!-- Title of the table -->
					<thead>
						<tr>
							<th class="height_col" colspan="2"><bean:message
								key="application_creation.config.rename" /></th>
						</tr>
					</thead>
					<!-- Content of the table -->
					<tbody>
						<tr>
							<af:field name="createApplicationForm"
								key="application.creation.field.application_name"
								property="applicationName" isRequired="true" accessKey="admin"
								styleClassLabel="td1Ext" access="READWRITE" />
						</tr>
					</tbody>
				</table>
				<br />
				...
				<table width="100%" class="formulaire" cellpadding="0"
					...
					<thead>
						<tr>
							<th class="height_col" colspan="2"><bean:message
								key="application_creation.config.config" /></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><af:select property="serveurForm.serveurId"
								isRequired="true">
								<af:option key="empty" value=""></af:option>
								<logic:iterate name="listeServeur" property="serveurs"
									scope="request" id="site" type="ServeurForm">
									<af:option value='<%=site.getServeurId() + ""%>'><%=site.getName()%></af:option>
								</logic:iterate>
							</af:select></td>
						</tr>
						<tr>
						...
						<tr>
							<af:field key="application_creation.config.audit_frequency"
								property="auditFrequency" isRequired="true"
								styleClassLabel="td1Ext" styleId="frequencyField" />
						</tr>
						<tr>
						...
						<tr>
							<af:field key="application_creation.config.public"
								type="CHECKBOX" property="public" accessKey="admin"
								styleClassLabel="td1Ext" overridePageAccess="true" />
						</tr>
					</tbody>
				</table>
				<br />
				...
				<table width="100%" class="formulaire" cellpadding="0"
					...
					<thead>
						<tr>
							<th class="height_col" colspan="2"><bean:message
								key="application_creation.config.information" /></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<af:field key="application_creation.config.inProduction"
								type="CHECKBOX" property="isInProduction"
								styleClassLabel="td1Ext" />
						</tr>
						<tr>
						...
						<tr>
							<af:field key="application_creation.config.qualityAtBeginning"
								type="CHECKBOX" property="qualityApproachOnStart"
								styleClassLabel="td1Ext" />
						</tr>
					</tbody>
				</table>
				...
				<table width="100%" class="formulaire" cellpadding="0"
					...
					<thead>
						<tr>
							<th class="height_col" colspan="2"><bean:message
								key="application_creation.config.cost" /></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<af:field key="application_creation.config.initialPhase"
								type="RADIO" property="inInitialDev" value="true"
								styleClassLabel="td1Ext" styleId="iniDevTrue"
								onclick="setEnabledCost()" />
						</tr>


						<tr>
							<af:field key="application_creation.config.initialGlobalCost"
								property="globalCostInitial" isRequired="false"
								styleClassLabel="td1Ext" styleId="globalCostInitialField" />
						</tr>
						...
						<tr>
							<af:field key="application_creation.config.maintenancePhase"
								type="RADIO" property="inInitialDev" value="false"
								styleClassLabel="td1Ext" styleId="iniDevFalse"
								onclick="setEnabledCost()" />
						</tr>
						<tr>
							<af:field key="application_creation.config.maintenanceGlobalCost"
								property="globalCostMaintenance" isRequired="false"
								styleClassLabel="td1Ext" styleId="globalCostMaintenanceField" />
						</tr>
					</tbody>
				</table>
				<br />
