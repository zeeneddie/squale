...
<af:page>
	<af:body>
		<af:canvasCenter titleKey="<%=title%>" subTitleKey="application_creation.subtitle.rights">
			...
			<af:form action="add_user.do">
				<input type="hidden"
					...
					value="true">
				<table id="rights" width="100%" class="formulaire" cellpadding="0" cellspacing="0" border="0">
					<THEAD>
						<tr>
							<th width="180px" align="center">
								<bean:message key="application_creation.rights.matricule"/>
							</th>
							<th>
								<bean:message key="application_creation.rights.profile" />
							</th>
						</tr>
					</THEAD>
					...
					<tr style="display: none">
						<td align="center">
							<af:field key="empty" property="matricule" writeTD="false" 
							value="" easyCompleteCallBackUrl="<%=callbackUrl%>"/>
						</td>
						<td>
							<af:select property="rightProfile" lazyLoading="false">
								<logic:iterate name="myRightProfiles" id="myRightProfile" type="java.lang.String">
					...
					<logic:iterate name="createApplicationForm" id="user" property="rights">
						<bean:define name="user" property="key" id="userMatricule" type="String" />
						<tr>
							<td align="center"> 
								<af:field key="empty" property="matricule"
								writeTD="false" value="<%=userMatricule%>" easyCompleteCallBackUrl="<%=callbackUrl%>"/>
							</td>
							<td>
								<bean:define name="user" property="value" id="right" type="String" />
								<af:select property="rightProfile" lazyLoading="false">
								<logic:iterate name="myRightProfiles" id="myRightProfile" type="java.lang.String">
									<option value="<%=myRightProfile%>" 
										<%if (myRightProfile.equals(right)) { out.print("selected");}%>>
					...
					<logic:equal name="nbUsers" value="0">
						<tr>
							<td align="right">
								<af:field key="empty" property="matricule" writeTD="false" value="" />
							</td>
							<td>
								<af:select property="rightProfile" lazyLoading="false">
									<logic:iterate name="myRightProfiles" id="myRightProfile" type="java.lang.String">
				...
				<af:buttonBar>
					...
					<af:button type="form" name="add.user" toolTipKey="toolTip.add.user" onclick="addField('rights', 1);"
						singleSend="false" />
					<af:button type="form" name="valider" toolTipKey="toolTip.valider" callMethod="addRights" />
				</af:buttonBar>
			</af:form>
		</af:canvasCenter>
	</af:body>
